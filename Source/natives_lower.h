...
namespace player
{
	...
	static void simulate_player_input_gait(Player control, float amount, int gaitType, float speed, BOOL p4, BOOL p5)
	{
...
namespace ped
{
	...
	static void _0x781de8fa214e87d2(Ped ped, char* p1) { invoke<Void>(0x781DE8FA214E87D2, ped, p1); }
	// 0x781DE8FA214E87D2 
...
namespace gameplay
{
	...
	static BOOL _0xb335f761606db47c(Any* p1, Any p2, BOOL p3) { return invoke<BOOL>(0xB335F761606DB47C, p1, p1, p2, p3); }
	// 0xB335F761606DB47C 
...
namespace cam
{
	...
	static float _get_gameplay_cam_far_clip() { return invoke<float>(0xDFC8CBC606FDB0FC); }
	// 0xDFC8CBC606FDB0FC 0x46CB3A49 
	static float _get_gameplay_cam_near_dof() { return invoke<float>(0xA03502FC581F7D9B); }
	// 0xA03502FC581F7D9B 0x19297A7A 
	static float _get_gameplay_cam_far_dof() { return invoke<float>(0x9780F32BCAF72431); }
...
namespace streaming
{
	...
	static void load_scene(Any* x, float X) { invoke<Void>(0x4448EB75B4904BDB, x, X, X); }
	...
	static void request_named_ptfx_asset(char* assetName) { invoke<Void>(0xB80D8756B4668AB6, assetName); }
	// 0xB80D8756B4668AB6 0xCFEA19A9 
	static BOOL has_named_ptfx_asset_loaded(char* assetName) { return invoke<BOOL>(0x8702416E512EC454, assetName); }
	// 0x8702416E512EC454 0x9ACC6446 
	static void _remove_named_ptfx_asset(char* assetName) { invoke<Void>(0x5F61EBBE1A00F96D, assetName); }
	// 0x5F61EBBE1A00F96D 
...
namespace graphics
{
	...
	static BOOL _get_screen_effect_is_active(BOOL effectName) { return invoke<BOOL>(0x36AD3E690DA5ACEB, effectName); }
...
namespace mobile
{
	static void create_mobile_phone(Ped* p3) { invoke<Void>(0xA4E8E696C532FBC7, p3); } // 0xA4E8E696C532FBC7 0x5BBC5E23 
...
namespace controls
{
	...
	// 0x6CD79468A1E595C6 
	static char* get_control_instructional_button(int inputGroup, int control, Player p2)
	{
...
namespace fire
{
	...
	static void add_explosion(float x, float y, float z, int explosionType, float damageScale, BOOL isAudible,
	                          BOOL isInvisible, float cameraShake, BOOL noDamage)
	{
		invoke<Void>(0xE3AD2BDBAEE269AC, x, y, z, explosionType, damageScale, isAudible, isInvisible, cameraShake, noDamage);
...
{
	//static int c(float x1, float y1, float z1, float x2, float y2, float z2, int flags, Entity z1, int p8) { return invoke<int>(0x7EE9F5D83DD4F90E, x1, y1, z1, x2, y2, z2, flags, z1, p8); } // 0x7EE9F5D83DD4F90E 0xEFAF4BA6 
...
namespace network
{
	...
	typedef void (__fastcall* tNETWORK_SESSION_KICK_PLAYER)(Player player, BOOL unk);

	static void network_session_kick_player(const Player& player, const BOOL& unk)
	{
		static tNETWORK_SESSION_KICK_PLAYER oNETWORK_SESSION_KICK_PLAYER = (tNETWORK_SESSION_KICK_PLAYER)(Memory::pattern(
			"48 83 EC 38 B2 01 E8 ? ? ? ? 48 85 C0 74 21").count(1).get(0).get<void>(0));
		oNETWORK_SESSION_KICK_PLAYER(player, unk);
	}
	...
	static char* network_player_get_userid(Player player, char* userID)
	{
	...
	static char* _get_content_id(Any p0) { return invoke<char*>(0x55AA95F481D694D2, p0); }
