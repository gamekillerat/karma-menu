...
namespace PLAYER
{
	...
	static char* GET_PLAYER_NAME(Player player) { return invoke<char*>(0x6D0DE6A7B5DA71F8, player); }
	...
	static void _0xDE45D1A1EF45EE61(Player player, BOOL toggle) { invoke<Void>(0xDE45D1A1EF45EE61, player, toggle); }
	...
	static void FORCE_CLEANUP_FOR_ALL_THREADS_WITH_THIS_NAME(char* name, int cleanupFlags)
	{
	...
	static void SPECIAL_ABILITY_CHARGE_CONTINUOUS(Player player, Ped p2) { invoke<Void>(0xED481732DFF7E997, player, p2); }
	...
	static void SPECIAL_ABILITY_DEPLETE_METER(Player player, BOOL p1) { invoke<Void>(0x1D506DBBBC51E64B, player, p1); }
	...
	static void ENABLE_SPECIAL_ABILITY(Player player, BOOL toggle) { invoke<Void>(0x181EC197DAEFE121, player, toggle); }
	...
	static BOOL _0xDD2620B7B9D16FF1(Player player, float p1) { return invoke<BOOL>(0xDD2620B7B9D16FF1, player, p1); }
	// 0xDD2620B7B9D16FF1 0x8CB53C9F
	static void START_PLAYER_TELEPORT(Player player, float x, float y, float z, float heading, BOOL p5, BOOL p6, BOOL p7)
	{
	...
	static void SIMULATE_PLAYER_INPUT_GAIT(Player player, float amount, int gaitType, float speed, BOOL p4, BOOL p5)
	{
		invoke<Void>(0x477D5D63E63ECA5D, player, amount, gaitType, speed, p4, p5);
...
namespace ENTITY
{
	...
	static BOOL HAS_ENTITY_ANIM_FINISHED(Entity entity, char* animDict, char* animName, int p3)
	{
	...
	static float GET_ENTITY_ANIM_CURRENT_TIME(Entity entity, char* animDict, char* animName)
	{
		return invoke<float>(0x346D81500D088F42, entity, animDict, animName);
	} // 0x346D81500D088F42 0x83943F41
	static float GET_ENTITY_ANIM_TOTAL_TIME(Entity entity, char* animDict, char* animName)
	{
		return invoke<float>(0x50BD2730B191E360, entity, animDict, animName);
	} // 0x50BD2730B191E360 0x433A9D18
	static float _GET_ANIM_DURATION(char* animDict, char* animName)
	{
	...
	static char* GET_ENTITY_SCRIPT(Entity entity, ScrHandle* script)
	{
		return invoke<char*>(0xA6E9C38DB51D7748, entity, script);
	...
	{
		return invoke<BOOL>(0x51210CED3DA1C78A, entity, originX, originY, originZ, edgeX, edgeY, edgeZ, angle, p8, p9, p10);
	} // 0x51210CED3DA1C78A 0x883622FA
	static BOOL IS_ENTITY_IN_AREA(Entity entity, float x1, float y1, float z1, float x2, float y2, float z2, BOOL p7,
	                              BOOL p8, Any p9)
	{
		return invoke<BOOL>(0x54736AA40E271165, entity, x1, y1, z1, x2, y2, z2, p7, p8, p9);
	} // 0x54736AA40E271165 0x8C2DFA9D
	static BOOL IS_ENTITY_IN_ZONE(Entity entity, char* zone) { return invoke<BOOL>(0xB6463CF6AF527071, entity, zone); }
	...
	static BOOL IS_ENTITY_PLAYING_ANIM(Entity entity, char* animDict, char* animName, int taskFlag)
	{
	...
	static void APPLY_FORCE_TO_ENTITY_CENTER_OF_MASS(Entity entity, int forceType, float x, float y, float z, BOOL p5,
	...
	static void APPLY_FORCE_TO_ENTITY(Entity entity, int forceFlags, float x, float y, float z, float offX, float offY,
	...
	static void ATTACH_ENTITY_TO_ENTITY(Entity entity1, Entity entity2, int boneIndex, float xPos, float yPos, float zPos,
	                                    float xRot, float yRot, float zRot, BOOL p9, BOOL useSoftPinning, BOOL collision,
	                                    BOOL isPed, int vertexIndex, BOOL fixedRot)
	{
		invoke<Void>(0x6B9BBD38AB0796DF, entity1, entity2, boneIndex, xPos, yPos, zPos, xRot, yRot, zRot, p9, useSoftPinning,
	...
	static void ATTACH_ENTITY_TO_ENTITY_PHYSICALLY(Entity entity1, Entity entity2, int boneIndex1, int boneIndex2,
	                                               ...
	                                               float zPos2, float xRot, float yRot, float zRot, float breakForce,
	                                               BOOL fixedRot, BOOL p15, BOOL collision, BOOL p17, int p18)
	{
		invoke<Void>(0xC3675780C92F90F9, entity1, entity2, boneIndex1, boneIndex2, xPos1, yPos1, zPos1, xPos2, yPos2, zPos2,
	...
	static int GET_ENTITY_BONE_INDEX_BY_NAME(Entity entity, char* boneName)
	{
	...
	static void _SET_ENTITY_SOMETHING(Entity entity, BOOL toggle) { invoke<Void>(0x3910051CCECDB00C, entity, toggle); }
	// 0x3910051CCECDB00C 0xD3850671
	static BOOL PLAY_ENTITY_ANIM(Entity entity, char* animName, char* animDict, float p3, BOOL loop, BOOL stayInAnim,
	                             BOOL p6, float delta, Any bitset)
	{
		return invoke<BOOL>(0x7FB218262B810701, entity, animName, animDict, p3, loop, stayInAnim, p6, delta, bitset);
	} // 0x7FB218262B810701 0x878753D5
	static BOOL PLAY_SYNCHRONIZED_ENTITY_ANIM(Entity entity, int syncedScene, char* animation, char* propName, float p4,
	                                          float p5, Any p6, float p7)
	{
		return invoke<BOOL>(0xC77720A12FE14A86, entity, syncedScene, animation, propName, p4, p5, p6, p7);
	} // 0xC77720A12FE14A86 0x012760AA
	static BOOL PLAY_SYNCHRONIZED_MAP_ENTITY_ANIM(float p0, float p1, float p2, float p3, Any p4, Any p5, Any* p6, Any* p7,
	                                              float p8, float p9, Any p10, float p11)
	{
	...
	static Any STOP_ENTITY_ANIM(Entity entity, char* animation, char* animGroup, float p3)
	{
	...
	static BOOL FIND_ANIM_EVENT_PHASE(char* animDictionary, char* animName, char* p2, Any* p3, Any* p4)
	{
		return invoke<BOOL>(0x07F1BE2BCCAA27A7, animDictionary, animName, p2, p3, p4);
	} // 0x07F1BE2BCCAA27A7 0xC41DDA62
	static void SET_ENTITY_ANIM_CURRENT_TIME(Entity entity, char* animDictionary, char* animName, float time)
	{
		invoke<Void>(0x4487C259F0F70977, entity, animDictionary, animName, time);
	} // 0x4487C259F0F70977 0x99D90735
	static void SET_ENTITY_ANIM_SPEED(Entity entity, char* animDictionary, char* animName, float speedMultiplier)
	{
	...
	static void SET_ENTITY_COORDS(Entity entity, float xPos, float yPos, float zPos, BOOL xAxis, BOOL yAxis, BOOL zAxis,
	                              BOOL clearArea)
	{
		invoke<Void>(0x06843DA7060A026B, entity, xPos, yPos, zPos, xAxis, yAxis, zAxis, clearArea);
	} // 0x06843DA7060A026B 0xDF70B41B
	static void _SET_ENTITY_COORDS_2(Entity entity, float xPos, float yPos, float zPos, BOOL xAxis, BOOL yAxis, BOOL zAxis,
	                                 BOOL clearArea)
	{
		invoke<Void>(0x621873ECE1178967, entity, xPos, yPos, zPos, xAxis, yAxis, zAxis, clearArea);
	} // 0x621873ECE1178967
	static void SET_ENTITY_COORDS_NO_OFFSET(Entity entity, float xPos, float yPos, float zPos, BOOL xAxis, BOOL yAxis,
	                                        BOOL zAxis)
	{
	...
	static void SET_ENTITY_INVINCIBLE(Entity entity, BOOL toggle) { invoke<Void>(0x3882114BDE571AD4, entity, toggle); }
	...
	{
		invoke<Void>(0xFAEE099C6F890BB8, entity, bulletProof, fireProof, explosionProof, collisionProof, meleeProof, p6, p7,
		             drownProof);
	...
	{
		invoke<Void>(0x44A0870B7E92D7C0, entity, alphaLevel, skin);
...
namespace PED
{
	...
	static BOOL IS_PED_SHOOTING_IN_AREA(Ped ped, float x1, float y1, float z1, float x2, float y2, float z2, BOOL p7,
	                                    BOOL p8)
	{
	...
	static void SET_PED_STEALTH_MOVEMENT(Ped ped, BOOL p1, char* action)
	{
	...
	static Any SET_PED_PINNED_DOWN(Ped ped, BOOL pinned, int i) { return invoke<Any>(0xAAD6D1ACF08F4612, ped, pinned, i); }
	...
	static Any ADD_RELATIONSHIP_GROUP(char* name, Hash* groupHash)
	{
	...
	static void _0x952F06BEECD775CC(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x952F06BEECD775CC, p0, p1, p2, p3); }
	// 0x952F06BEECD775CC
	...
	static void SET_PED_MOVEMENT_CLIPSET(Ped ped, char* clipSet, float p2)
	{
	...
	static void SET_PED_STRAFE_CLIPSET(Ped ped, char* clipSet) { invoke<Void>(0x29A28F3F8CF6D854, ped, clipSet); }
	...
	static void SET_PED_WEAPON_MOVEMENT_CLIPSET(Ped ped, char* clipSet) { invoke<Void>(0x2622E35B77D3ACA2, ped, clipSet); }
	...
	static void SET_PED_DRIVE_BY_CLIPSET_OVERRIDE(Ped ped, char* clipset)
	{
	...
	static BOOL IS_SCRIPTED_SCENARIO_PED_USING_CONDITIONAL_ANIM(Ped ped, char* animDict, char* anim)
	{
		return invoke<BOOL>(0x6EC47A344923E1ED, ped, animDict, anim);
	} // 0x6EC47A344923E1ED 0x3C30B447
	static void SET_PED_ALTERNATE_WALK_ANIM(Ped ped, char* animDict, char* animName, float p3, BOOL p4)
	{
	...
	static void SET_PED_ALTERNATE_MOVEMENT_ANIM(Ped ped, int stance, char* animDictionary, char* animationName, float p4,
	                                            BOOL p5)
	{
	...
	static void SET_PED_GESTURE_GROUP(Ped ped, char* animGroupGesture)
	{
		invoke<Void>(0xDDF803377F94AAA8, ped, animGroupGesture);
	} // 0xDDF803377F94AAA8 0x170DA109
	static Vector3 GET_ANIM_INITIAL_OFFSET_POSITION(char* animDict, char* animName, float x, float y, float z, float xRot,
	                                                float yRot, float zRot, float p8, int p9)
	{
		return invoke<Vector3>(0xBE22B26DD764C040, animDict, animName, x, y, z, xRot, yRot, zRot, p8, p9);
	} // 0xBE22B26DD764C040 0xC59D4268
	static Vector3 GET_ANIM_INITIAL_OFFSET_ROTATION(char* animDict, char* animName, float x, float y, float z, float xRot,
	                                                float yRot, float zRot, float p8, int p9)
	{
	...
	static void SET_PED_HEAD_BLEND_DATA(Ped ped, int shapeFirstID, int shapeSecondID, int shapeThirdID, int skinFirstID,
	                                    int skinSecondID, int skinThirdID, float shapeMix, float skinMix, float thirdMix,
	                                    BOOL isParent)
	{
	...
	static int GET_PED_PROP_INDEX(Ped ped, int componentId) { return invoke<int>(0x898CC20EA75BACD8, ped, componentId); }
	...
	static Ped GET_RANDOM_PED_AT_COORD(float x, float y, float z, float xRadius, float yRadius, float zRadius, int pedType)
	{
		return invoke<Ped>(0x876046A8E3A4B71C, x, y, z, xRadius, yRadius, zRadius, pedType);
	} // 0x876046A8E3A4B71C 0xDC8239EB
	static BOOL GET_CLOSEST_PED(float x, float y, float z, float radius, BOOL p4, BOOL p5, Ped* outPed, BOOL p7, BOOL p8,
	                            int pedType)
	{
	...
	{
		return invoke<BOOL>(0xD76632D99E4966C8, ped, time, p2, ragdollType, x, y, z, p7, p8, p9, p10, p11, p12, p13);
	...
	static void SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_PED(Ped ped, Ped target, float xOffset, float yOffset, float zOffset,
	...
	static void SET_PED_DEFENSIVE_AREA_ATTACHED_TO_PED(Ped ped, Ped attachPed, float p2, float p3, float p4, float p5,
	                                                   float p6, float p7, float p8, BOOL p9, BOOL p10)
	{
	...
	static void APPLY_PED_BLOOD(Ped ped, int boneIndex, float xRot, float yRot, float zRot, char* woundType)
	{
	...
	static void APPLY_PED_DAMAGE_DECAL(Ped ped, int p1, float p2, float p3, float p4, float p5, float p6, int p7, BOOL p8,
	                                   char* p9)
	{
		invoke<Void>(0x397C38AA7B4A5F83, ped, p1, p2, p3, p4, p5, p6, p7, p8, p9);
	} // 0x397C38AA7B4A5F83 0x8A13A41F
	static void APPLY_PED_DAMAGE_PACK(Ped ped, char* damagePack, float damage, float mult)
	{
	...
	static void CLEAR_PED_DAMAGE_DECAL_BY_ZONE(Ped ped, int p1, char* p2)
	{
	...
	static int ADD_SCENARIO_BLOCKING_AREA(float x1, float y1, float z1, float x2, float y2, float z2, BOOL p6, BOOL p7,
	                                      BOOL p8, BOOL p9)
	{
	...
	static BOOL IS_PED_USING_SCENARIO(Ped ped, char* scenario) { return invoke<BOOL>(0x1BF094736DD62C2E, ped, scenario); }
	...
	static void PLAY_FACIAL_ANIM(Ped ped, char* animName, char* animDict)
	{
		invoke<Void>(0xE1E65CA8AC9C00ED, ped, animName, animDict);
	} // 0xE1E65CA8AC9C00ED 0x1F6CCDDE
	static void SET_FACIAL_IDLE_ANIM_OVERRIDE(Ped ped, char* animName, char* animDict)
	{
	...
	static void SET_PED_HELMET_PROP_INDEX(Ped ped, int propIndex) { invoke<Void>(0x26D83693ED99291C, ped, propIndex); }
	...
	static void SET_PED_COWER_HASH(Ped ped, char* p1) { invoke<Void>(0xA549131166868ED3, ped, p1); }
	...
	static ScrHandle _CAN_PED_SEE_PED(Ped ped1, Ped ped2) { return invoke<ScrHandle>(0x6CD5A433374D4CFB, ped1, ped2); }
	...
	static void _0xD69411AA0CEBF9E9(Ped ped, int p1, int p2, int p3) { invoke<Void>(0xD69411AA0CEBF9E9, ped, p1, p2, p3); }
	...
	static void SET_SYNCHRONIZED_SCENE_ORIGIN(int sceneID, float x, float y, float z, float roll, float pitch, float yaw,
	                                          BOOL p7)
	{
	...
	static void SET_PED_USING_ACTION_MODE(Ped ped, BOOL p1, Any p2, char* action)
	{
	...
	static void _0x2DF9038C90AD5264(float p0, float p1, float p2, float p3, float p4, int interiorFlags, float scale,
	                                int duration)
	{
		invoke<Void>(0x2DF9038C90AD5264, p0, p1, p2, p3, p4, interiorFlags, scale, duration);
	} // 0x2DF9038C90AD5264 0x909A1D76
	static void _0xB2AFF10216DEFA2F(float x, float y, float z, float p3, float p4, float p5, float p6, int interiorFlags,
	...
	static void SET_IK_TARGET(Ped ped, int ikIndex, Entity entityLookAt, int boneLookAt, float offsetX, float offsetY,
	                          float offsetZ, Any p7, int blendInDuration, int blendOutDuration)
	{
	...
	static void _0xCB968B53FC7F916D(Any p0, BOOL p1, Any p2, Any p3) { invoke<Void>(0xCB968B53FC7F916D, p0, p1, p2, p3); }
...
namespace VEHICLE
{
	...
	{
		return invoke<int>(0x9DEF883114668116, x, y, z, heading, p4, p5, modelHash, p7, p8, p9, p10, p11, p12, p13, p14, p15,
		                   p16);
	...
	static void SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(float x1, float y1, float z1, float x2, float y2, float z2,
	                                                      BOOL p6, BOOL p7)
	{
	...
	static BOOL SET_VEHICLE_ON_GROUND_PROPERLY(Vehicle vehicle) { return invoke<BOOL>(0x49733E92263139D1, vehicle); }
	...
	static int GET_VEHICLE_NUMBER_OF_PASSENGERS(Vehicle vehicle) { return invoke<int>(0x24CB2137731FFE89, vehicle); }
	...
	static BOOL _0xF7F203E31F96F6A1(Vehicle vehicle, BOOL flag) { return invoke<BOOL>(0xF7F203E31F96F6A1, vehicle, flag); }
	// 0xF7F203E31F96F6A1 0x769E5CF2
	static BOOL _0xE33FFA906CE74880(Vehicle vehicle, Any p1) { return invoke<BOOL>(0xE33FFA906CE74880, vehicle, p1); }
	// 0xE33FFA906CE74880
	...
	static void _0x9737A37136F07E75(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x9737A37136F07E75, vehicle, toggle); }
	...
	static BOOL IS_VEHICLE_IN_GARAGE_AREA(char* garageName, Vehicle vehicle)
	{
	...
	static void STEER_UNLOCK_BIAS(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x07116E24E9D1929D, vehicle, toggle); }
	...
	static void _0x37EBBF3117BD6A25(Vehicle vehicle, float height) { invoke<Void>(0x37EBBF3117BD6A25, vehicle, height); }
	...
	static Vehicle _GET_VEHICLE_ATTACHED_TO_ENTITY(Vehicle object) { return invoke<Vehicle>(0x375E7FC44F21C8AB, object); }
	...
	static void _0x6A98C2ECF57FA5D4(Vehicle vehicle, Entity entity) { invoke<Void>(0x6A98C2ECF57FA5D4, vehicle, entity); }
	...
	static void SMASH_VEHICLE_WINDOW(Vehicle vehicle, int index) { invoke<Void>(0x9E5B5E4D2CCD2259, vehicle, index); }
	...
	static void _0x16B5E274BDE402F8(Vehicle vehicle, Vehicle trailer, float p2, float p3, float p4, float p5, float p6,
	...
	static void SET_VEHICLE_NUMBER_PLATE_TEXT(Vehicle vehicle, char* plateText)
	{
		invoke<Void>(0x95A88F0B409CDA47, vehicle, plateText);
	} // 0x95A88F0B409CDA47 0x400F9556
	static char* GET_VEHICLE_NUMBER_PLATE_TEXT(Vehicle vehicle) { return invoke<char*>(0x7CE1CCB9B293020E, vehicle); }
	...
	static Vehicle* GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(Vehicle elegy)
	{
		return invoke<Vehicle*>(0xF11BC2DD9A3E7195, elegy);
	...
	static BOOL HAS_VEHICLE_RECORDING_BEEN_LOADED(Any p0, Any* p1) { return invoke<BOOL>(0x300D614A4C785FC4, p0, p1); }
	...
	static Vector3 GET_POSITION_OF_VEHICLE_RECORDING_AT_TIME(int p0, float p1, char* p2)
	{
	...
	static float GET_TOTAL_DURATION_OF_VEHICLE_RECORDING_ID(Any p0) { return invoke<float>(0x102D125411A7B6E6, p0); }
	// 0x102D125411A7B6E6 0x7116785E
	static Any GET_TOTAL_DURATION_OF_VEHICLE_RECORDING(Any p0, Any p1) { return invoke<Any>(0x0E48D1C262390950, p0, p1); }
	...
	static void START_PLAYBACK_RECORDED_VEHICLE(Vehicle vehicle, int p1, char* playback, BOOL p3)
	{
		invoke<Void>(0x3F878F92B3A7A071, vehicle, p1, playback, p3);
	} // 0x3F878F92B3A7A071 0xCF614CA8
	static void START_PLAYBACK_RECORDED_VEHICLE_WITH_FLAGS(Vehicle vehicle, Any p1, char* playback, Any p3, Any p4, Any p5)
	{
	...
	static void SKIP_TIME_IN_PLAYBACK_RECORDED_VEHICLE(Any p0, float p1) { invoke<Void>(0x9438F7AD68771A20, p0, p1); }
	// 0x9438F7AD68771A20 0xCF3EFA4B
	static void SET_PLAYBACK_TO_USE_AI(Vehicle vehicle, int flag) { invoke<Void>(0xA549C3B37EA28131, vehicle, flag); }
	...
	static Vehicle GET_RANDOM_VEHICLE_BACK_BUMPER_IN_SPHERE(float p0, float p1, float p2, float p3, int p4, int p5, int p6)
	{
	...
	static void _0xBE5C1255A1830FF5(Vehicle vehicle, BOOL toggle) { invoke<Void>(0xBE5C1255A1830FF5, vehicle, toggle); }
	...
	static void _SET_VEHICLE_SILENT(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x9D44FCCE98450843, vehicle, toggle); }
	...
	static char* GET_DISPLAY_NAME_FROM_VEHICLE_MODEL(Hash modelHash)
	{
		return invoke<char*>(0xB215AAC32D25D019, modelHash);
	...
	static void SET_VEHICLE_LIVERY(Vehicle vehicle, Hash livery) { invoke<Void>(0x60BF608F1B8CD1B6, vehicle, livery); }
	// 0x60BF608F1B8CD1B6 0x7AD87059
	static Vehicle GET_VEHICLE_LIVERY(Vehicle trailers2) { return invoke<Vehicle>(0x2BB9230590DA5E8A, trailers2); }
	...
	static BOOL WAS_COUNTER_ACTIVATED(Vehicle vehicle, Any p1) { return invoke<BOOL>(0x3EC8BF18AA453FE9, vehicle, p1); }
	// 0x3EC8BF18AA453FE9 0x2916D69B
	static void SET_VEHICLE_NAME_DEBUG(Vehicle vehicle, char* name) { invoke<Void>(0xBFDF984E2C22B94F, vehicle, name); }
	...
	static BOOL _0xA4822F1CF23F4810(Vector3* outVec, Any p1, Vector3* outVec1, Any p3, Any p4, Any p5, Any p6, Any p7,
	                                Any p8)
	{
	...
	static void SET_VEHICLE_RUDDER_BROKEN(Vehicle vehicle, BOOL p1) { invoke<Void>(0x09606148B6C71DEF, vehicle, p1); }
	...
	static float _GET_VEHICLE_MODEL_MAX_SPEED(Hash modelHash) { return invoke<float>(0xF417C2502FFFED43, modelHash); }
	...
	static float _GET_VEHICLE_MODEL_HAND_BRAKE(Hash modelHash) { return invoke<float>(0xBFBA3BA79CFF7EBF, modelHash); }
	...
	static float _GET_VEHICLE_MODEL_DOWN_FORCE(Hash modelHash) { return invoke<float>(0x53409B5163D5B846, modelHash); }
	...
	static float _GET_VEHICLE_CLASS_MAX_SPEED(int vehicleClass) { return invoke<float>(0x00C09F246ABEDD82, vehicleClass); }
	...
	static char* GET_VEHICLE_MOD_COLOR_1_NAME(Vehicle vehicle, BOOL p1)
	{
		return invoke<char*>(0xB45085B721EFD38C, vehicle, p1);
	} // 0xB45085B721EFD38C 0x9A0840FD
	static char* GET_VEHICLE_MOD_COLOR_2_NAME(Vehicle vehicle) { return invoke<char*>(0x4967A516ED23A5A1, vehicle); }
	...
	static char* GET_MOD_TEXT_LABEL(Vehicle vehicle, int modType, int modValue)
	{
		return invoke<char*>(0x8935624F8C5592CC, vehicle, modType, modValue);
	} // 0x8935624F8C5592CC 0x0BA39CA7
	static char* GET_MOD_SLOT_NAME(Vehicle vehicle, int modType)
	{
		return invoke<char*>(0x51F0FEB9F6AE98C0, vehicle, modType);
	} // 0x51F0FEB9F6AE98C0 0x5E113483
	static char* GET_LIVERY_NAME(Vehicle vehicle, int liveryIndex)
	{
		return invoke<char*>(0xB4C7A93837C91A1F, vehicle, liveryIndex);
	...
	static void PRELOAD_VEHICLE_MOD(Any p0, int modType, Any p2) { invoke<Void>(0x758F49C24925568A, p0, modType, p2); }
	...
	static BOOL _IS_VEHICLE_SHOP_RESPRAY_ALLOWED(Vehicle vehicle) { return invoke<BOOL>(0x8D474C8FAEFF6CDE, vehicle); }
	...
	static void _0xF0E4BA16D1DB546C(Vehicle vehicle, int p1, int p2) { invoke<Void>(0xF0E4BA16D1DB546C, vehicle, p1, p2); }
	...
	static void _0xAD2D28A1AFDFF131(Vehicle vehicle, float value) { invoke<Void>(0xAD2D28A1AFDFF131, vehicle, value); }
	...
	// 0x571FEB383F629926
	static Vector3 _GET_CARGOBOB_HOOK_POSITION(Vehicle cargobob) { return invoke<Vector3>(0xCBDB9B923CACC92D, cargobob); }
	// 0xCBDB9B923CACC92D
	...
	static BOOL _DOES_CARGOBOB_HAVE_PICKUP_MAGNET(Vehicle cargobob) { return invoke<BOOL>(0x6E08BF5B3722BAC9, cargobob); }
	// 0x6E08BF5B3722BAC9
	...
	// 0xF78F94D60248C737
	static void SET_VEHICLE_CEILING_HEIGHT(Vehicle vehicle, float p1) { invoke<Void>(0xA46413066687A328, vehicle, p1); }
	// 0xA46413066687A328 0x98A10A86
	static void _0x5E569EC46EC21CAE(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x5E569EC46EC21CAE, vehicle, toggle); }
	...
	static void SET_VEHICLE_EXCLUSIVE_DRIVER(Vehicle vehicle, Ped ped) { invoke<Void>(0x41062318F23ED854, vehicle, ped); }
	...
	static float _GET_VEHICLE_SUSPENSION_HEIGHT(Vehicle vehicle) { return invoke<float>(0x53952FD2BAA19F17, vehicle); }
	...
	static void SET_VEHICLE_ROCKET_BOOST_AMOUNT(float amount) { Memory::set_value<float>({ 0x8, 0xD28, 0x31C }, amount); }
}
...
namespace OBJECT
{
	...
	static Object CREATE_OBJECT_NO_OFFSET(Hash modelHash, float x, float y, float z, BOOL isNetwork, BOOL thisScriptCheck,
	                                      BOOL dynamic)
	{
	...
	static BOOL SLIDE_OBJECT(Object object, float toX, float toY, float toZ, float speedX, float speedY, float speedZ,
	                         BOOL collision)
	{
	...
	static Object GET_CLOSEST_OBJECT_OF_TYPE(float x, float y, float z, float radius, Hash modelHash, BOOL isMission,
	                                         BOOL p6, BOOL p7)
	{
	...
	static void GET_STATE_OF_CLOSEST_DOOR_OF_TYPE(Hash type, float x, float y, float z, BOOL* locked, float* heading)
	{
	...
	static void ADD_DOOR_TO_SYSTEM(Hash doorHash, Hash modelHash, float x, float y, float z, BOOL p5, BOOL p6, BOOL p7)
	{
	...
	static BOOL IS_GARAGE_EMPTY(Any garage, BOOL p1, int p2) { return invoke<BOOL>(0x90E47239EA1980B8, garage, p1, p2); }
	...
	static BOOL IS_POINT_IN_ANGLED_AREA(float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7,
	                                    float p8, float p9, BOOL p10, BOOL p11)
	{
	...
	static int _GET_DES_OBJECT(float x, float y, float z, float rotation, char* name)
	{
	...
	{
		return invoke<Pickup>(0x891804727E0A98B7, pickupHash, posX, posY, posZ, rotX, rotY, rotZ, flag, amount, p9, p10,
		                      modelHash);
	...
	{
		return invoke<Pickup>(0x673966A0C0FD7171, pickupHash, posX, posY, posZ, p4, value, modelHash, returnHandle, p8);
	} // 0x673966A0C0FD7171 0x17B99CE7
	static Pickup CREATE_PORTABLE_PICKUP(Hash pickupHash, float x, float y, float z, BOOL placeOnGround, Hash modelHash)
	{
		return invoke<Pickup>(0x2EAF1FDB2FB55698, pickupHash, x, y, z, placeOnGround, modelHash);
	} // 0x2EAF1FDB2FB55698 0x8C886BE5
	static Pickup _CREATE_PORTABLE_PICKUP_2(Hash pickupHash, float x, float y, float z, BOOL placeOnGround, Hash modelHash)
	{
	...
	static void _0xB2D0BDE54F0E8E5A(Object object, BOOL toggle) { invoke<Void>(0xB2D0BDE54F0E8E5A, object, toggle); }
...
namespace AI
{
	...
	static void TASK_VEHICLE_DRIVE_TO_COORD(Ped ped, Vehicle vehicle, float x, float y, float z, float speed, Any p6,
	                                        Hash vehicleModel, int drivingMode, float stopRange, float p10)
	{
		invoke<Void>(0xE2A2AA2F659D77A7, ped, vehicle, x, y, z, speed, p6, vehicleModel, drivingMode, stopRange, p10);
	} // 0xE2A2AA2F659D77A7 0xE4AC0387
	static void TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(Ped ped, Vehicle vehicle, float x, float y, float z, float speed,
	                                                  int driveMode, float stopRange)
	{
	...
	{
		invoke<Void>(0x304AE42E357B8C7E, ped, entity, offsetX, offsetY, offsetZ, movementSpeed, timeout, stoppingRange,
		             persistFollowing);
	...
	static void TASK_GO_STRAIGHT_TO_COORD_RELATIVE_TO_ENTITY(Entity entity1, Entity entity2, float p2, float p3, float p4,
	                                                         float p5, Any p6)
	{
	...
	static void TASK_SMART_FLEE_COORD(Ped ped, float x, float y, float z, float distance, int time, BOOL p6, BOOL p7)
	{
	...
	static void TASK_FOLLOW_NAV_MESH_TO_COORD_ADVANCED(Ped ped, float x, float y, float z, float speed, int timeout,
	                                                   float unkFloat, int unkInt, float unkX, float unkY, float unkZ,
	                                                   float unk_40000f)
	{
		invoke<Void>(0x17F58B88D085DBAC, ped, x, y, z, speed, timeout, unkFloat, unkInt, unkX, unkY, unkZ, unk_40000f);
	...
	static void TASK_GO_TO_COORD_ANY_MEANS_EXTRA_PARAMS(Ped ped, float x, float y, float z, float speed, Any p5, BOOL p6,
	                                                    int walkingStyle, float p8, Any p9, Any p10, Any p11)
	{
		invoke<Void>(0x1DD45F9ECFDB1BC9, ped, x, y, z, speed, p5, p6, walkingStyle, p8, p9, p10, p11);
	} // 0x1DD45F9ECFDB1BC9 0x094B75EF
	static void TASK_GO_TO_COORD_ANY_MEANS_EXTRA_PARAMS_WITH_CRUISE_SPEED(Ped ped, float x, float y, float z, float speed,
	                                                                      Any p5, BOOL p6, int walkingStyle, float p8,
	                                                                      Any p9, Any p10, Any p11, Any p12)
	{
		invoke<Void>(0xB8ECD61F531A7B02, ped, x, y, z, speed, p5, p6, walkingStyle, p8, p9, p10, p11, p12);
	} // 0xB8ECD61F531A7B02 0x86DC03F9
	static void TASK_PLAY_ANIM(Ped ped, char* animDictionary, char* animationName, float speed, float speedMultiplier,
	...
	static void TASK_PLAY_ANIM_ADVANCED(Ped ped, char* animDict, char* animName, float posX, float posY, float posZ,
	                                    float rotX, float rotY, float rotZ, float speed, float speedMultiplier,
	                                    int duration, Any flag, float animTime, Any p14, Any p15)
	{
		invoke<Void>(0x83CDB10EA29B370B, ped, animDict, animName, posX, posY, posZ, rotX, rotY, rotZ, speed, speedMultiplier,
		             duration, flag, animTime, p14, p15);
	} // 0x83CDB10EA29B370B 0x3DDEB0E6
	static void STOP_ANIM_TASK(Ped ped, char* animDictionary, char* animationName, float p3)
	{
	...
	static void SET_ANIM_LOOPED(Any p0, BOOL p1, Any p2, BOOL p3) { invoke<Void>(0x70033C3CC29A1FF4, p0, p1, p2, p3); }
	// 0x70033C3CC29A1FF4 0x095D61A4
	static void TASK_PLAY_PHONE_GESTURE_ANIMATION(Ped ped, char* animDict, char* animation, char* boneMaskType, float p4,
	                                              float p5, BOOL p6, BOOL p7)
	{
	...
	static void TASK_VEHICLE_PLAY_ANIM(Vehicle vehicle, char* animation_set, char* animation_name)
	{
	...
	static void TASK_AIM_GUN_SCRIPTED_WITH_TARGET(Any p0, Any p1, float p2, float p3, float p4, Any p5, BOOL p6, BOOL p7)
	{
	...
	{
		invoke<Void>(0x338E7EF52B6095A9, ped, entity, duration, xOffset, yOffset, zOffset, moveBlendRatio, useNavmesh);
	...
	static void TASK_VEHICLE_MISSION(int p0, int p1, Vehicle veh, Any p3, float p4, Any p5, float p6, float p7, BOOL p8)
	{
	...
	{
		invoke<Void>(0x9454528DF15D657A, ped, vehicle, pedTarget, mode, maxSpeed, drivingStyle, minDistance, p7, p8);
	} // 0x9454528DF15D657A 0xC81C4677
	static void TASK_VEHICLE_MISSION_COORS_TARGET(Ped ped, Vehicle vehicle, float x, float y, float z, int p5, int p6,
	                                              int p7, float p8, float p9, BOOL p10)
	{
	...
	static void _TASK_VEHICLE_FOLLOW(Ped driver, Vehicle vehicle, Entity targetEntity, int drivingStyle, float speed,
	                                 int minDistance)
	{
	...
	static void TASK_VEHICLE_HELI_PROTECT(Ped pilot, Vehicle vehicle, Entity entityToFollow, float targetSpeed, int p4,
	                                      float radius, int altitude, int p7)
	{
	...
	static void TASK_PLANE_LAND(Ped pilot, Vehicle plane, float runwayStartX, float runwayStartY, float runwayStartZ,
	                            float runwayEndX, float runwayEndY, float runwayEndZ)
	{
		invoke<Void>(0xBF19721FA34D32C0, pilot, plane, runwayStartX, runwayStartY, runwayStartZ, runwayEndX, runwayEndY,
		             runwayEndZ);
	} // 0xBF19721FA34D32C0 0x5F7E23EA
	static void TASK_HELI_MISSION(Ped pilot, Vehicle aircraft, Vehicle targetVehicle, Ped targetPed, float destinationX,
	                              float destinationY, float destinationZ, int missionFlag, float maxSpeed,
	                              float landingRadius, float targetHeading, int unk1, int unk2, Hash unk3,
	                              int landingFlags)
	{
		invoke<Void>(0xDAD029E187A2BEB4, pilot, aircraft, targetVehicle, targetPed, destinationX, destinationY, destinationZ,
		             missionFlag, maxSpeed, landingRadius, targetHeading, unk1, unk2, unk3, landingFlags);
	} // 0xDAD029E187A2BEB4 0x0C143E97
	static void TASK_PLANE_MISSION(Ped pilot, Vehicle aircraft, Vehicle targetVehicle, Ped targetPed, float destinationX,
	                               float destinationY, float destinationZ, int missionFlag, float angularDrag, float unk,
	                               float targetHeading, float maxZ, float minZ)
	{
		invoke<Void>(0x23703CD154E83B88, pilot, aircraft, targetVehicle, targetPed, destinationX, destinationY, destinationZ,
		             missionFlag, angularDrag, unk, targetHeading, maxZ, minZ);
	...
	{
		invoke<Void>(0x2F8AF0E82773A171, driverPed, targetPed, targetVehicle, targetX, targetY, targetZ, distanceToShoot,
		             pedAccuracy, p8, firingPattern);
	...
	static void SET_MOUNTED_WEAPON_TARGET(Ped shootingPed, Ped targetPed, Vehicle targetVehicle, float x, float y, float z)
	{
	...
	static void TASK_PED_SLIDE_TO_COORD_HDG_RATE(Ped ped, float x, float y, float z, float heading, float p5, float p6)
	{
	...
	static void TASK_SEEK_COVER_TO_COORDS(Ped ped, float x1, float y1, float z1, float x2, float y2, float z2, Any p7,
	                                      BOOL p8)
	{
	...
	static void TASK_STAND_GUARD(Ped ped, float x, float y, float z, float heading, char* scenarioName)
	{
	...
	static void TASK_START_SCENARIO_IN_PLACE(Ped ped, char* scenarioName, int unkDelay, BOOL playEnterAnim)
	{
		invoke<Void>(0x142A02425FF02BD9, ped, scenarioName, unkDelay, playEnterAnim);
	} // 0x142A02425FF02BD9 0xE50D6DDE
	static void TASK_START_SCENARIO_AT_POSITION(Ped ped, char* scenarioName, float x, float y, float z, float heading,
	                                            int duration, BOOL sittingScenario, BOOL teleport)
	{
	...
	static void TASK_USE_NEAREST_SCENARIO_CHAIN_TO_COORD_WARP(Any p0, float p1, float p2, float p3, float p4, Any p5)
	{
	...
	static void PLAY_ANIM_ON_RUNNING_SCENARIO(Ped ped, char* animDict, char* animName)
	{
	...
	static void SET_SCENARIO_GROUP_ENABLED(char* scenarioGroup, BOOL p1)
	{
	...
	static void SET_SCENARIO_TYPE_ENABLED(char* scenarioType, BOOL toggle)
	{
	...
	static void ADD_PATROL_ROUTE_NODE(int p0, char* p1, float x1, float y1, float z1, float x2, float y2, float z2, int p8)
	{
	...
	static void TASK_PATROL(Ped ped, char* p1, Any p2, BOOL p3, BOOL p4)
	{
	...
	static void TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(Ped ped, float x, float y, float z, float aimAtX, float aimAtY,
	                                                   float aimAtZ, float moveSpeed, BOOL p8, float p9, float p10,
	                                                   BOOL p11, Any flags, BOOL p13, Hash firingPattern)
	{
		invoke<Void>(0x11315AB3385B8AC0, ped, x, y, z, aimAtX, aimAtY, aimAtZ, moveSpeed, p8, p9, p10, p11, flags, p13,
		             firingPattern);
	} // 0x11315AB3385B8AC0 0x1552DC91
	static void TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(Any p0, float p1, float p2, float p3, Any p4, float p5, BOOL p6,
	                                                    float p7, float p8, BOOL p9, Any p10, BOOL p11, Any p12, Any p13)
	{
		invoke<Void>(0xB2A16444EAD9AE47, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13);
	} // 0xB2A16444EAD9AE47 0x9BD52ABD
	static void TASK_GO_TO_COORD_AND_AIM_AT_HATED_ENTITIES_NEAR_COORD(Ped pedHandle, float goToLocationX,
	                                                                  float goToLocationY, float goToLocationZ,
	                                                                  float focusLocationX, float focusLocationY,
	                                                                  float focusLocationZ, float speed,
	                                                                  BOOL shootAtEnemies, float distanceToStopAt,
	                                                                  float noRoadsDistance, BOOL unkTrue, int unkFlag,
	                                                                  int aimingFlag, Hash firingPattern)
	{
		invoke<Void>(0xA55547801EB331FC, pedHandle, goToLocationX, goToLocationY, goToLocationZ, focusLocationX,
		             focusLocationY, focusLocationZ, speed, shootAtEnemies, distanceToStopAt, noRoadsDistance, unkTrue,
		             unkFlag, aimingFlag, firingPattern);
	} // 0xA55547801EB331FC 0x3F91358E
	static void TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(Any p0, Any p1, float p2, float p3, float p4, float p5, BOOL p6,
	                                                    float p7, float p8, BOOL p9, BOOL p10, Any p11)
	{
		invoke<Void>(0x04701832B739DCE5, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11);
	} // 0x04701832B739DCE5 0xD896CD82
	static void TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(Ped ped, Entity entityToWalkTo, Entity entityToAimAt, float speed,
	                                                     BOOL shootatEntity, float p5, float p6, BOOL p7, BOOL p8,
	                                                     Hash firingPattern)
	{
	...
	static BOOL WAYPOINT_RECORDING_GET_NUM_POINTS(char* name, int* points)
	{
		return invoke<BOOL>(0x5343532C01A07234, name, points);
	} // 0x5343532C01A07234 0xF5F9B71E
	static BOOL WAYPOINT_RECORDING_GET_COORD(char* name, int point, Vector3* coord)
	{
		return invoke<BOOL>(0x2FB897405C90B361, name, point, coord);
	} // 0x2FB897405C90B361 0x19266913
	static float WAYPOINT_RECORDING_GET_SPEED_AT_POINT(char* name, int point)
	{
		return invoke<float>(0x005622AEBC33ACA9, name, point);
	} // 0x005622AEBC33ACA9 0xC765633A
	static BOOL WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(char* name, float x, float y, float z, int* point)
	{
	...
	static void _0xE70BA7B90F8390DC(Any p0, Any p1, BOOL p2, Any p3) { invoke<Void>(0xE70BA7B90F8390DC, p0, p1, p2, p3); }
	// 0xE70BA7B90F8390DC
	...
	static void ASSISTED_MOVEMENT_SET_ROUTE_PROPERTIES(char* route, int props)
	{
	...
	static void TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Ped ped, Vehicle vehicle, char* WPRecording, int p3, int p4, int p5,
	                                                   int p6, float p7, BOOL p8, float p9)
	{
	...
	static void _TASK_MOVE_NETWORK(Ped ped, char* task, float multiplier, BOOL p3, char* animDict, int flags)
	{
		invoke<Void>(0x2D537BA194896636, ped, task, multiplier, p3, animDict, flags);
	} // 0x2D537BA194896636 0x6F5D215F
	static void _TASK_MOVE_NETWORK_ADVANCED(Ped ped, char* p1, float p2, float p3, float p4, float p5, float p6, float p7,
	                                        Any p8, float p9, BOOL p10, char* animDict, int flags)
	{
	...
	static Any _0xD01015C7316AE176(Ped ped, char* p1) { return invoke<Any>(0xD01015C7316AE176, ped, p1); }
	// 0xD01015C7316AE176 0x885724DE
	static Any _0xAB13A5565480B6D9(Any p0, Any p1) { return invoke<Any>(0xAB13A5565480B6D9, p0, p1); }
	// 0xAB13A5565480B6D9
	static char* _0x717E4D1F2048376D(Ped ped) { return invoke<char*>(0x717E4D1F2048376D, ped); }
	// 0x717E4D1F2048376D 0x96C0277B
	static void _0xD5BB4025AE449A4E(Ped ped, char* p1, float p2) { invoke<Void>(0xD5BB4025AE449A4E, ped, p1, p2); }
	// 0xD5BB4025AE449A4E 0xA79BE783
	static void _0xB0A6CFD2C69C1088(Ped ped, char* p1, BOOL p2) { invoke<Void>(0xB0A6CFD2C69C1088, ped, p1, p2); }
	// 0xB0A6CFD2C69C1088 0xF3538041
	static BOOL _0xA7FFBA498E4AAF67(Ped ped, char* p1) { return invoke<BOOL>(0xA7FFBA498E4AAF67, ped, p1); }
	...
	static void TASK_SYNCHRONIZED_SCENE(Ped ped, int scene, char* animDictionary, char* animationName, float speed,
	                                    float speedMultiplier, int duration, int flag, float playbackRate, Any p9)
	{
		invoke<Void>(0xEEA929141F699854, ped, scene, animDictionary, animationName, speed, speedMultiplier, duration, flag,
		             playbackRate, p9);
	} // 0xEEA929141F699854 0x4F217E7B
	static void TASK_SWEEP_AIM_ENTITY(Ped ped, char* anim, char* p2, char* p3, char* p4, int p5, Vehicle vehicle, float p7,
	                                  float p8)
	{
	...
	static void TASK_SWEEP_AIM_POSITION(Any p0, Any* p1, Any* p2, Any* p3, Any* p4, Any p5, float p6, float p7, float p8,
	                                    float p9, float p10)
	{
...
namespace GAMEPLAY
{
	...
	static void _SET_WEATHER_TYPE_OVER_TIME(char* weatherType, float time)
	{
	...
	static void _SET_CLOUD_HAT_TRANSITION(char* type, float transitionTime)
	{
	...
	static Vector3 _0x21C235BC64831E5A(float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7,
	                                   float p8, BOOL p9)
	{
	...
	static BOOL IS_AREA_OCCUPIED(float p0, float p1, float p2, float p3, float p4, float p5, BOOL p6, BOOL p7, BOOL p8,
	                             BOOL p9, BOOL p10, Any p11, BOOL p12)
	{
		return invoke<BOOL>(0xA61B4DF533DCB56E, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12);
	} // 0xA61B4DF533DCB56E 0xC013972F
	static BOOL IS_POSITION_OCCUPIED(float x, float y, float z, float range, BOOL p4, BOOL p5, BOOL p6, BOOL p7, BOOL p8,
	                                 Any p9, BOOL p10)
	{
		return invoke<BOOL>(0xADCDE75E1C60F32D, x, y, z, range, p4, p5, p6, p7, p8, p9, p10);
	} // 0xADCDE75E1C60F32D 0x452E8D9E
	static BOOL IS_POINT_OBSCURED_BY_A_MISSION_ENTITY(float p0, float p1, float p2, float p3, float p4, float p5, Any p6)
	{
	...
	static void SHOOT_SINGLE_BULLET_BETWEEN_COORDS(float x1, float y1, float z1, float x2, float y2, float z2, int damage,
	                                               BOOL p7, Hash weaponHash, Ped ownerPed, BOOL isAudible,
	                                               BOOL isInvisible, float speed)
	{
	...
	static void _SHOOT_SINGLE_BULLET_BETWEEN_COORDS_WITH_ENTITY(float x1, float y1, float z1, float x2, float y2, float z2,
	                                                            int damage, BOOL p7, Hash weaponHash, Ped ownerPed,
	                                                            BOOL isAudible, BOOL isInvisible, float speed,
	                                                            Entity entity)
	{
		invoke<Void>(0xE3A7742E0B7A2F8B, x1, y1, z1, x2, y2, z2, damage, p7, weaponHash, ownerPed, isAudible, isInvisible,
		             speed, entity);
	} // 0xE3A7742E0B7A2F8B 0x52ACCB7B
	static void _SHOOT_SINGLE_BULLET_BETWEEN_COORDS_WITH_EXTRA_PARAMS(float x1, float y1, float z1, float x2, float y2,
	                                                                  float z2, int damage, BOOL p7, Hash weaponHash,
	                                                                  Ped ownerPed, BOOL isAudible, BOOL isInvisible,
	                                                                  float speed, Entity entity, BOOL p14, BOOL p15,
	                                                                  BOOL p16, BOOL p17)
	{
		invoke<Void>(0xBFE5756E7407064A, x1, y1, z1, x2, y2, z2, damage, p7, weaponHash, ownerPed, isAudible, isInvisible,
	...
	static BOOL ARE_STRINGS_EQUAL(char* string1, char* string2)
	{
		return invoke<BOOL>(0x0C515FAB3FF9EA92, string1, string2);
	} // 0x0C515FAB3FF9EA92 0x877C0BC5
	static int COMPARE_STRINGS(char* str1, char* str2, BOOL matchCase, int maxLength)
	{
	...
	static BOOL IS_PROJECTILE_TYPE_IN_ANGLED_AREA(float p0, float p1, float p2, float p3, float p4, float p5, float p6,
	                                              Any p7, BOOL p8)
	{
	...
	static BOOL STRING_TO_INT(char* string, int* outInteger)
	{
	...
	static int ADD_STUNT_JUMP(float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7, float p8,
	                          float p9, float p10, float p11, float p12, float p13, float p14, Any p15, Any p16)
	{
		return invoke<int>(0x1A992DA297A4630C, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16);
	...
	static int ADD_STUNT_JUMP_ANGLED(float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7,
	                                 ...
	                                 float p16, Any p17, Any p18)
	{
		return invoke<int>(0xBBE5D803A5360CBF, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17,
		                   p18);
	...
	static void REGISTER_INT_TO_SAVE(Any* p0, char* name) { invoke<Void>(0x34C9EE5986258415, p0, name); }
	...
	static void REGISTER_ENUM_TO_SAVE(Any* p0, char* name) { invoke<Void>(0x10C2FA78D0E128A1, p0, name); }
	// 0x10C2FA78D0E128A1 0x9B38374A
	static void REGISTER_FLOAT_TO_SAVE(Any* p0, char* name) { invoke<Void>(0x7CAEC29ECB5DFEBB, p0, name); }
	// 0x7CAEC29ECB5DFEBB 0xDB06F7AD
	static void REGISTER_BOOL_TO_SAVE(Any* p0, char* name) { invoke<Void>(0xC8F4131414C835A1, p0, name); }
	// 0xC8F4131414C835A1 0x5417E0E0
	static void REGISTER_TEXT_LABEL_TO_SAVE(Any* p0, char* name) { invoke<Void>(0xEDB1232C5BEAE62F, p0, name); }
	// 0xEDB1232C5BEAE62F 0x284352C4
	static void _0x6F7794F28C6B2535(Any* p0, char* name) { invoke<Void>(0x6F7794F28C6B2535, p0, name); }
	// 0x6F7794F28C6B2535 0xE2089749
	static void _0x48F069265A0E4BEC(Any* p0, char* name) { invoke<Void>(0x48F069265A0E4BEC, p0, name); }
	// 0x48F069265A0E4BEC 0xF91B8C33
	static void _0x8269816F6CFD40F8(Any* p0, char* name) { invoke<Void>(0x8269816F6CFD40F8, p0, name); }
	// 0x8269816F6CFD40F8 0x74E8FAD9
	static void _0xFAA457EF263E8763(Any* p0, char* name) { invoke<Void>(0xFAA457EF263E8763, p0, name); }
	// 0xFAA457EF263E8763 0x6B4335DD
	static void _START_SAVE_STRUCT(Any* p0, int p1, char* structName)
	{
	...
	static void _START_SAVE_ARRAY(Any* p0, int p1, char* arrayName)
	{
	...
	static BOOL FIND_SPAWN_POINT_IN_DIRECTION(float x1, float y1, float z1, float x2, float y2, float z2, float distance,
	                                          Vector3* spawnPoint)
	{
	...
	static void _0x54F157E0336A3822(Any p0, char* p1, float p2) { invoke<Void>(0x54F157E0336A3822, p0, p1, p2); }
	...
	static void _DISPLAY_ONSCREEN_KEYBOARD_2(int p0, char* windowTitle, Any* p2, char* defaultText, char* defaultConcat1,
	                                         char* defaultConcat2, char* defaultConcat3, char* defaultConcat4,
	                                         char* defaultConcat5, char* defaultConcat6, char* defaultConcat7,
	                                         int maxInputLength)
	{
		invoke<Void>(0xCA78CFA0366592FE, p0, windowTitle, p2, defaultText, defaultConcat1, defaultConcat2, defaultConcat3,
		             defaultConcat4, defaultConcat5, defaultConcat6, defaultConcat7, maxInputLength);
	} // 0xCA78CFA0366592FE 0xD2688412
	static void DISPLAY_ONSCREEN_KEYBOARD(int p0, char* windowTitle, char* p2, char* defaultText, char* defaultConcat1,
	                                      char* defaultConcat2, char* defaultConcat3, int maxInputLength)
	{
		invoke<Void>(0x00DC833F2568DBF6, p0, windowTitle, p2, defaultText, defaultConcat1, defaultConcat2, defaultConcat3,
		             maxInputLength);
	...
	static void _0x0A60017F841A54F2(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x0A60017F841A54F2, p0, p1, p2, p3); }
	...
	static void _0x1BB299305C3E8C13(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x1BB299305C3E8C13, p0, p1, p2, p3); }
	// 0x1BB299305C3E8C13 0xA27F4472
	static BOOL _0x8EF5573A1F801A5C(Any p0, Any* p1, Any* p2) { return invoke<BOOL>(0x8EF5573A1F801A5C, p0, p1, p2); }
...
namespace AUDIO
{
	static void PLAY_PED_RINGTONE(char* ringtoneName, Ped ped, BOOL p2)
	{
	...
	static void ADD_LINE_TO_CONVERSATION(int p0, char* p1, char* p2, int p3, int p4, BOOL p5, BOOL p6, BOOL p7, BOOL p8,
	                                     int p9, BOOL p10, BOOL p11, BOOL p12)
	{
		invoke<Void>(0xC5EF963405593646, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12);
	} // 0xC5EF963405593646 0x96CD0513
	static void ADD_PED_TO_CONVERSATION(Any p0, Any ped, char* p2) { invoke<Void>(0x95D9F4BC443956E7, p0, ped, p2); }
	...
	static void SET_MICROPHONE_POSITION(BOOL p0, float x1, float y1, float z1, float x2, float y2, float z2, float x3,
	                                    float y3, float z3)
	{
	...
	static void _0x8A694D7A68F8DC38(Ped p0, char* p1, char* p2) { invoke<Void>(0x8A694D7A68F8DC38, p0, p1, p2); }
	// 0x8A694D7A68F8DC38
	...
	static void PLAY_SOUND(Player soundId, char* audioName, char* audioRef, BOOL p3, Any p4, BOOL p5)
	{
		invoke<Void>(0x7FF4944CC209192D, soundId, audioName, audioRef, p3, p4, p5);
	} // 0x7FF4944CC209192D 0xB6E1917F
	static void PLAY_SOUND_FRONTEND(int soundId, char* audioName, char* audioRef, BOOL p3)
	{
	...
	static void PLAY_SOUND_FROM_ENTITY(int soundId, char* audioName, Entity entity, char* audioRef, BOOL p4, Any p5)
	{
		invoke<Void>(0xE65F427EB70AB1ED, soundId, audioName, entity, audioRef, p4, p5);
	} // 0xE65F427EB70AB1ED 0x95AE00F8
	static void PLAY_SOUND_FROM_COORD(int soundId, char* audioName, float x, float y, float z, char* audioRef, BOOL p6,
	                                  int range, BOOL p8)
	{
	...
	static void _PLAY_AMBIENT_SPEECH1(Ped ped, char* speechName, char* speechParam)
	{
		invoke<Void>(0x8E04FEDD28D42462, ped, speechName, speechParam);
	} // 0x8E04FEDD28D42462 0x5C57B85D
	static void _PLAY_AMBIENT_SPEECH2(Ped ped, char* speechName, char* speechParam)
	{
		invoke<Void>(0xC6941B4A3A8FBBB9, ped, speechName, speechParam);
	} // 0xC6941B4A3A8FBBB9 0x444180DB
	static void _PLAY_AMBIENT_SPEECH_WITH_VOICE(Ped p0, char* speechName, char* voiceName, char* speechParam, BOOL p4)
	{
		invoke<Void>(0x3523634255FC3318, p0, speechName, voiceName, speechParam, p4);
	} // 0x3523634255FC3318 0x8386AE28
	static void _PLAY_AMBIENT_SPEECH_AT_COORDS(char* p0, char* p1, float p2, float p3, float p4, char* p5)
	{
	...
	static void SET_PLAYER_ANGRY(Ped playerPed, BOOL disabled) { invoke<Void>(0xEA241BB04110F091, playerPed, disabled); }
	...
	static BOOL _CAN_PED_SPEAK(Ped ped, char* speechName, BOOL unk)
	{
	...
	static void SET_VEH_RADIO_STATION(Vehicle vehicle, char* radioStation)
	{
	...
	static void SET_EMITTER_RADIO_STATION(char* emitterName, char* radioStation)
	{
		invoke<Void>(0xACF57305B12AF907, emitterName, radioStation);
	} // 0xACF57305B12AF907 0x87431585
	static void SET_STATIC_EMITTER_ENABLED(char* emitterName, BOOL toggle)
	{
	...
	static void SET_RADIO_TRACK(char* radioStation, char* radioTrack)
	{
	...
	static void _0x4E404A9361F75BB2(char* radioStation, char* p1, BOOL p2)
	{
	...
	static void SET_AMBIENT_ZONE_LIST_STATE(Any* p0, BOOL p1, BOOL p2) { invoke<Void>(0x9748FA4DE50CCE3E, p0, p1, p2); }
	...
	static void SET_AMBIENT_ZONE_STATE_PERSISTENT(char* ambientZone, BOOL p1, BOOL p2)
	{
		invoke<Void>(0x1D6650420CEC9D3B, ambientZone, p1, p2);
	} // 0x1D6650420CEC9D3B 0xC1FFB672
	static void SET_AMBIENT_ZONE_LIST_STATE_PERSISTENT(char* ambientZone, BOOL p1, BOOL p2)
	{
	...
	static Any PLAY_POLICE_REPORT(char* name, float p1) { return invoke<Any>(0xDFEBD56D9BD1EB16, name, p1); }
	...
	static BOOL LOAD_STREAM(char* streamName, char* soundSet)
	{
		return invoke<BOOL>(0x1F1F957154EC51DF, streamName, soundSet);
	} // 0x1F1F957154EC51DF 0x0D89599D
	static BOOL LOAD_STREAM_WITH_START_OFFSET(char* streamName, int startOffset, char* soundSet)
	{
	...
	static void _FORCE_VEHICLE_ENGINE_AUDIO(Vehicle vehicle, char* audioName)
	{
		invoke<Void>(0x4F0C413926060B38, vehicle, audioName);
	} // 0x4F0C413926060B38 0x33B0B007
	static void _0xF1F8157B8C3F171C(Any p0, char* p1, char* p2) { invoke<Void>(0xF1F8157B8C3F171C, p0, p1, p2); }
	...
	static void PLAY_VEHICLE_DOOR_OPEN_SOUND(Vehicle vehicle, int p1) { invoke<Void>(0x3A539D52857EA82D, vehicle, p1); }
	// 0x3A539D52857EA82D 0x84930330
	static void PLAY_VEHICLE_DOOR_CLOSE_SOUND(Vehicle vehicle, int p1) { invoke<Void>(0x62A456AA4769EF34, vehicle, p1); }
	// 0x62A456AA4769EF34 0xBA2CF407
	static void _0xC15907D667F7CFB2(Vehicle vehicle, BOOL toggle) { invoke<Void>(0xC15907D667F7CFB2, vehicle, toggle); }
	...
	static void SET_AUDIO_SCENE_VARIABLE(char* scene, char* variable, float value)
	{
	...
	static void _0xFBE20329593DEC9D(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xFBE20329593DEC9D, p0, p1, p2, p3); }
	...
	static Any PREPARE_SYNCHRONIZED_AUDIO_EVENT(char* p0, Any p1) { return invoke<Any>(0xC7ABCACA4985A766, p0, p1); }
	...
	static void _SET_SYNCHRONIZED_AUDIO_EVENT_POSITION_THIS_FRAME(char* p0, Entity p1)
	{
...
namespace CUTSCENE
{
	...
	static void _REQUEST_CUTSCENE_EX(char* cutsceneName, int p1, int p2)
	{
	...
	static void _0x4C61C75BEE8184C2(char* p0, Any p1, Any p2) { invoke<Void>(0x4C61C75BEE8184C2, p0, p1, p2); }
	...
	static Entity GET_ENTITY_INDEX_OF_CUTSCENE_ENTITY(char* cutsceneEntName, Hash modelHash)
	{
	...
	static BOOL _0x4CEBC1ED31E8925E(char* cutsceneName) { return invoke<BOOL>(0x4CEBC1ED31E8925E, cutsceneName); }
	// 0x4CEBC1ED31E8925E
	static void REGISTER_ENTITY_FOR_CUTSCENE(Ped cutscenePed, char* cutsceneEntName, int p2, Hash modelHash, int p4)
	{
		invoke<Void>(0xE40C1C56DF95C2E8, cutscenePed, cutsceneEntName, p2, modelHash, p4);
	} // 0xE40C1C56DF95C2E8 0x7CBC3EC7
	static Entity GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(char* cutsceneEntName, Hash modelHash)
	{
	...
	static BOOL CAN_SET_ENTER_STATE_FOR_REGISTERED_ENTITY(char* cutsceneEntName, Hash modelHash)
	{
		return invoke<BOOL>(0x645D0B458D8E17B5, cutsceneEntName, modelHash);
	} // 0x645D0B458D8E17B5 0x55C30B26
	static BOOL CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(char* cutsceneEntName, Hash modelHash)
	{
	...
	static void SET_CUTSCENE_PED_COMPONENT_VARIATION(char* cutsceneEntName, int p1, int p2, int p3, Hash modelHash)
	{
		invoke<Void>(0xBA01E7B6DEEFBBC9, cutsceneEntName, p1, p2, p3, modelHash);
	} // 0xBA01E7B6DEEFBBC9 0x6AF994A1
	static void _0x2A56C06EBEF2B0D9(char* cutsceneEntName, Ped ped, Hash modelHash)
	{
		invoke<Void>(0x2A56C06EBEF2B0D9, cutsceneEntName, ped, modelHash);
	} // 0x2A56C06EBEF2B0D9 0x1E7DA95E
	static BOOL DOES_CUTSCENE_ENTITY_EXIST(char* cutsceneEntName, Hash modelHash)
	{
		return invoke<BOOL>(0x499EF20C5DB25C59, cutsceneEntName, modelHash);
	} // 0x499EF20C5DB25C59 0x58E67409
	static void SET_CUTSCENE_PED_PROP_VARIATION(char* cutsceneEntName, int p1, int p2, int p3, Hash modelHash)
	{
...
namespace INTERIOR
{
	...
	static void ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(Pickup pickup, char* roomName)
	{
	...
	// 0x4C2330E61D3DEB56
	static int GET_INTERIOR_AT_COORDS_WITH_TYPE(float x, float y, float z, char* interiorType)
	{
	...
	static void _ENABLE_INTERIOR_PROP(int interiorID, char* propName)
	{
		invoke<Void>(0x55E86AF2712B36A1, interiorID, propName);
	} // 0x55E86AF2712B36A1 0xC80A5DDF
	static void _DISABLE_INTERIOR_PROP(int interiorID, char* propName)
	{
		invoke<Void>(0x420BD37289EEE162, interiorID, propName);
	} // 0x420BD37289EEE162 0xDBA768A1
	static BOOL _IS_INTERIOR_PROP_ENABLED(int interiorID, char* propName)
	{
...
namespace CAM
{
	...
	static Cam CREATE_CAM(char* camName, BOOL p1) { return invoke<Cam>(0xC3981DCE61D9E13F, camName, p1); }
	// 0xC3981DCE61D9E13F 0xE9BF2A7D
	static Cam CREATE_CAM_WITH_PARAMS(char* camName, float posX, float posY, float posZ, float rotX, float rotY,
	                                  float rotZ, float fov, BOOL p8, int p9)
	{
	...
	static void DESTROY_CAM(Cam cam, BOOL thisScriptCheck) { invoke<Void>(0x865908C81A2C22E9, cam, thisScriptCheck); }
	...
	// 0x7DD234D6F3914C5B
	static void _SET_CAM_DOF_FOCUS_DISTANCE_BIAS(Cam camera, float p1) { invoke<Void>(0xC669EEA5D031B7DE, camera, p1); }
	// 0xC669EEA5D031B7DE
	...
	static void SET_CAM_DEBUG_NAME(Cam camera, char* name) { invoke<Void>(0x1B93E0107865DD40, camera, name); }
	// 0x1B93E0107865DD40 0x9B00DF3F
	static void ADD_CAM_SPLINE_NODE(Cam camera, float x, float y, float z, float xRot, float yRot, float zRot, int length,
	                                int p8, int p9)
	{
		invoke<Void>(0x8609C75EC438FB3B, camera, x, y, z, xRot, yRot, zRot, length, p8, p9);
	} // 0x8609C75EC438FB3B 0xAD3C7EAA
	static void _0x0A9F2A468B328E74(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x0A9F2A468B328E74, p0, p1, p2, p3); }
	// 0x0A9F2A468B328E74 0x30510511
	static void _0x0FB82563989CF4FB(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x0FB82563989CF4FB, p0, p1, p2, p3); }
	...
	static void _0x83B8201ED82A9A2D(Any p0, Any p1, Any p2, float p3) { invoke<Void>(0x83B8201ED82A9A2D, p0, p1, p2, p3); }
	...
	static void SHAKE_CAM(Cam cam, char* type, float amplitude) { invoke<Void>(0x6A25241C340D3822, cam, type, amplitude); }
	// 0x6A25241C340D3822 0x1D4211B0
	static void ANIMATED_SHAKE_CAM(Cam cam, char* p1, char* p2, char* p3, float amplitude)
	{
	...
	static void _0xC2EAE3FB8CDBED31(char* p0, char* p1, char* p2, float p3)
	{
	...
	static BOOL PLAY_CAM_ANIM(Cam cam, char* animName, char* animDictionary, float x, float y, float z, float xRot,
	...
	static BOOL IS_CAM_PLAYING_ANIM(Cam cam, char* animName, char* animDictionary)
	{
	...
	static BOOL PLAY_SYNCHRONIZED_CAM_ANIM(Any p0, Any p1, char* animName, char* animDictionary)
	{
	...
	static void SHAKE_GAMEPLAY_CAM(char* shakeName, float intensity)
	{
	...
	static void SET_GAMEPLAY_COORD_HINT(float x, float y, float z, int duration, int blendOutDuration, int blendInDuration,
	                                    int unk)
	{
	...
	static void SET_GAMEPLAY_ENTITY_HINT(Entity entity, float xOffset, float yOffset, float zOffset, BOOL p4, int p5,
	                                     int p6, int p7, Any p8)
	{
	...
	static Entity _0x89215EC747DF244A(float p0, int p1, float p2, float p3, float p4, float p5, float p6, int p7, int p8)
	{
	...
	static void _0x21E253A7F8DA5DFB(char* vehicleName) { invoke<Void>(0x21E253A7F8DA5DFB, vehicleName); }
	// 0x21E253A7F8DA5DFB
...
namespace WEAPON
{
	...
	static void SET_PED_DROPS_INVENTORY_WEAPON(Ped ped, Hash weaponHash, float xOffset, float yOffset, float zOffset,
	                                           int ammoCount)
	{
	...
	static int GET_PED_AMMO_BY_TYPE(Ped ped, Any ammoType) { return invoke<int>(0x39D22031557946C1, ped, ammoType); }
	...
	static Object CREATE_WEAPON_OBJECT(Hash weaponHash, int ammoCount, float x, float y, float z, BOOL showWorldModel,
	                                   float heading, Any p7)
	{
	...
	static void REMOVE_WEAPON_COMPONENT_FROM_WEAPON_OBJECT(Any p0, Any p1) { invoke<Void>(0xF7D82B0D66777611, p0, p1); }
...
namespace STREAMING
{
	...
	static void LOAD_SCENE(Any* x, float y, float z) { invoke<Void>(0x4448EB75B4904BDB, x, y, z); }
	...
	static void _REQUEST_INTERIOR_ROOM_BY_NAME(int interiorID, char* roomName)
	{
	...
	static Any _0x1F3F018BC3AFA77C(float p0, float p1, float p2, float p3, float p4, float p5, float p6, Any p7, Any p8)
	{
	...
	static void SET_PLAYER_SWITCH_OUTRO(float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7,
	                                    Any p8)
	{
	...
	static void _0xBEB2D9A1D9A8F55A(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xBEB2D9A1D9A8F55A, p0, p1, p2, p3); }
...
namespace SCRIPT
{
	...
	static BOOL _DOES_SCRIPT_WITH_NAME_HASH_EXIST(Hash scriptHash) { return invoke<BOOL>(0xF86AA3C56BA31381, scriptHash); }
	// 0xF86AA3C56BA31381
...
namespace UI
{
	static void _BEGIN_TEXT_COMMAND_BUSY_STRING(char* string) { invoke<Void>(0xABA17D7CE615ADBF, string); }
	// 0xABA17D7CE615ADBF 0xCB7C8994
	static void _END_TEXT_COMMAND_BUSY_STRING(int busySpinnerType) { invoke<Void>(0xBD12F8228410D9B4, busySpinnerType); }
	...
	static char* _IS_LOADING_PROMPT_BEING_DISPLAYED() { return invoke<char*>(0xD422FCC5F239A915); }
	...
	static void _SET_NOTIFICATION_TEXT_ENTRY(char* text) { invoke<Void>(0x202709F4C58A0424, text); }
	// 0x202709F4C58A0424 0x574EE85C
	static int _SET_NOTIFICATION_MESSAGE(char* picName1, int picName2, BOOL flash, int iconType, BOOL p4, char* sender,
	                                     char* subject)
	{
		return invoke<int>(0x2B7E9A4EAAA93C89, picName1, picName2, flash, iconType, p4, sender, subject);
	} // 0x2B7E9A4EAAA93C89 0xED130FA1
	static int _SET_NOTIFICATION_MESSAGE_2(char* picName1, char* picName2, BOOL flash, int iconType, char* sender,
	                                       char* subject)
	{
		return invoke<int>(0x1CCD9A37359072CF, picName1, picName2, flash, iconType, sender, subject);
	} // 0x1CCD9A37359072CF 0xE7E3C98B
	static int _SET_NOTIFICATION_MESSAGE_3(char* picName1, char* picName2, BOOL p2, Any p3, char* p4, char* p5)
	{
		return invoke<int>(0xC6F580E4C94926AC, picName1, picName2, p2, p3, p4, p5);
	} // 0xC6F580E4C94926AC
	static int _SET_NOTIFICATION_MESSAGE_4(char* picName1, char* picName2, BOOL flash, int iconType, char* sender,
	...
	static int _SET_NOTIFICATION_MESSAGE_CLAN_TAG(char* picName1, char* picName2, BOOL flash, int iconType, char* sender,
	                                              char* subject, float duration, char* clanTag)
	{
		return invoke<int>(0x5CBF7BADE20DB93E, picName1, picName2, flash, iconType, sender, subject, duration, clanTag);
	...
	static int _SET_NOTIFICATION_MESSAGE_CLAN_TAG_2(char* picName1, char* picName2, BOOL flash, int iconType1,
	                                                char* sender, char* subject, float duration, char* clanTag,
	                                                int iconType2, int p9)
	{
		return invoke<int>(0x531B84E7DA981FB6, picName1, picName2, flash, iconType1, sender, subject, duration, clanTag,
		                   iconType2, p9);
	...
	static int _DRAW_NOTIFICATION_AWARD(char* p0, char* p1, int p2, int p3, char* p4)
	{
	...
	static int _DRAW_NOTIFICATION_CLAN_INVITE(BOOL p0, BOOL p1, int* p2, int p3, BOOL isLeader, BOOL unk0, int clanDesc,
	                                          char* playerName, int R, int G, int B)
	{
	...
	static int _DRAW_NOTIFICATION_WITH_ICON(int type, int image, char* text)
	{
		return invoke<int>(0xD202B92CBF1D816F, type, image, text);
	} // 0xD202B92CBF1D816F
	static int _DRAW_NOTIFICATION_WITH_BUTTON(int type, char* button, char* text)
	{
	...
	static void BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* labelName)
	{
	...
	static char* _GET_TEXT_SUBSTRING(char* text, int position, int length)
	{
		return invoke<char*>(0x169BD9382084C8C0, text, position, length);
	} // 0x169BD9382084C8C0 0x34A396EE
	static char* _GET_TEXT_SUBSTRING_SAFE(char* text, int position, int length, int maxLength)
	{
		return invoke<char*>(0xB2798643312205C5, text, position, length, maxLength);
	} // 0xB2798643312205C5 0x0183A66C
	static char* _GET_TEXT_SUBSTRING_SLICE(char* text, int startPosition, int endPosition)
	{
		return invoke<char*>(0xCE94AEBA5D82908A, text, startPosition, endPosition);
	...
	static BOOL HAS_THIS_ADDITIONAL_TEXT_LOADED(char* gxt, int slot)
	{
	...
	static char* GET_STREET_NAME_FROM_HASH_KEY(Hash hash) { return invoke<char*>(0xD0EF8A959B8A4CB9, hash); }
	...
	static void SET_ABILITY_BAR_VALUE(float value, float maxValue) { invoke<Void>(0x9969599CCFF5D85E, value, maxValue); }
	...
	static Any GET_NAMED_RENDERTARGET_RENDER_ID(char* p0) { return invoke<Any>(0x1A6478B61C6BDC3B, p0); }
	...
	static void SET_BLIP_NAME_FROM_TEXT_FILE(Blip blip, char* gxtEntry)
	{
	...
	static Any SET_MINIMAP_COMPONENT(int p0, BOOL p1, int p2) { return invoke<Any>(0x75A9A10948D1DEA6, p0, p1, p2); }
	...
	static void _SET_MISSION_NAME_2(BOOL p0, char* name) { invoke<Void>(0xE45087D85F468BC2, p0, name); }
	...
	static void _0x784BA7E0ECEB4178(Any p0, float x, float y, float z) { invoke<Void>(0x784BA7E0ECEB4178, p0, x, y, z); }
	...
	static void _SET_MP_GAMER_TAG_COLOR(int headDisplayId, char* username, BOOL pointedClanTag, BOOL isRockstarClan,
	                                    char* clanTag, Any p5, int r, int g, int b)
	{
		invoke<Void>(0x6DD05E9D83EFA4C9, headDisplayId, username, pointedClanTag, isRockstarClan, clanTag, p5, r, g, b);
	...
	static int _CREATE_MP_GAMER_TAG(Ped ped, char* username, BOOL pointedClanTag, BOOL isRockstarClan, char* clanTag,
	                                Any p5)
	{
	...
	static void SET_MP_GAMER_TAG_NAME(int gamerTagId, char* string)
	{
	...
	static void _SET_MP_GAMER_TAG_CHATTING(int gamerTagId, char* string)
	{
	...
	static void SET_WARNING_MESSAGE(char* entryLine1, int instructionalKey, char* entryLine2, BOOL p3, Any p4, Any* p5,
	                                Any* p6, BOOL background)
	{
	...
	static void SET_WARNING_MESSAGE_WITH_HEADER(char* entryHeader, char* entryLine1, int instructionalKey,
	                                            char* entryLine2, BOOL p4, Any p5, Any* p6, Any* p7, BOOL background)
	{
		invoke<Void>(0xDC38CC1E35B6A5D7, entryHeader, entryLine1, instructionalKey, entryLine2, p4, p5, p6, p7, background);
	} // 0xDC38CC1E35B6A5D7 0x2DB9EAB5
	static void _SET_WARNING_MESSAGE_3(char* entryHeader, char* entryLine1, Any instructionalKey, char* entryLine2,
	                                   BOOL p4, Any p5, Any p6, Any* p7, Any* p8, BOOL p9)
	{
		invoke<Void>(0x701919482C74B5AB, entryHeader, entryLine1, instructionalKey, entryLine2, p4, p5, p6, p7, p8, p9);
	...
	static Any _0x551DF99658DB6EE8(float p0, float p1, float p2) { return invoke<Any>(0x551DF99658DB6EE8, p0, p1, p2); }
	...
	static BOOL _0xC8E1071177A23BE5(Any* p0, Any* p1, Any* p2) { return invoke<BOOL>(0xC8E1071177A23BE5, p0, p1, p2); }
	// 0xC8E1071177A23BE5
	...
	static BOOL _0xCA6B2F7CE32AB653(Any p0, Any* p1, Any p2) { return invoke<BOOL>(0xCA6B2F7CE32AB653, p0, p1, p2); }
	// 0xCA6B2F7CE32AB653
	...
	static BOOL _0x8F08017F9D7C47BD(Any p0, Any* p1, Any p2) { return invoke<BOOL>(0x8F08017F9D7C47BD, p0, p1, p2); }
	// 0x8F08017F9D7C47BD
	...
	static void _SET_AI_BLIP_MAX_DISTANCE(Ped ped, float distance) { invoke<Void>(0x97C65887D4B37FA9, ped, distance); }
...
namespace GRAPHICS
{
	...
	static void DRAW_DEBUG_LINE(float x1, float y1, float z1, float x2, float y2, float z2, int red, int green, int blue,
	                            int alpha)
	{
	...
	static void DRAW_DEBUG_BOX(float x1, float y1, float z1, float x2, float y2, float z2, int red, int green, int blue,
	                           int alpha)
	{
	...
	static void DRAW_DEBUG_TEXT(char* text, float x, float y, float z, int red, int green, int blue, int alpha)
	{
		invoke<Void>(0x3903E216620488E8, text, x, y, z, red, green, blue, alpha);
	} // 0x3903E216620488E8 0x269B006F
	static void DRAW_DEBUG_TEXT_2D(char* text, float x, float y, float z, int red, int green, int blue, int alpha)
	{
	...
	static void DRAW_LIGHT_WITH_RANGE(float posX, float posY, float posZ, int colorR, int colorG, int colorB, float range,
	                                  float intensity)
	{
	...
	static void DRAW_SPOT_LIGHT(float posX, float posY, float posZ, float dirX, float dirY, float dirZ, int colorR,
	                            int colorG, int colorB, float distance, float brightness, float hardness, float radius,
	                            float falloff)
	{
		invoke<Void>(0xD0F64B265C8C8B33, posX, posY, posZ, dirX, dirY, dirZ, colorR, colorG, colorB, distance, brightness,
	...
	{
		invoke<Void>(0x5BCA583A583194DB, posX, posY, posZ, dirX, dirY, dirZ, colorR, colorG, colorB, distance, brightness,
	...
	static void DRAW_MARKER(int type, float posX, float posY, float posZ, float dirX, float dirY, float dirZ, float rotX,
	                        float rotY, float rotZ, float scaleX, float scaleY, float scaleZ, int red, int green, int blue,
	                        int alpha, BOOL bobUpAndDown, BOOL faceCamera, int p19, BOOL rotate, char* textureDict,
	                        char* textureName, BOOL drawOnEnts)
	{
		invoke<Void>(0x28477EC23D892089, type, posX, posY, posZ, dirX, dirY, dirZ, rotX, rotY, rotZ, scaleX, scaleY, scaleZ,
		             red, green, blue, alpha, bobUpAndDown, faceCamera, p19, rotate, textureDict, textureName, drawOnEnts);
	} // 0x28477EC23D892089 0x48D84A02
	static int CREATE_CHECKPOINT(int type, float posX1, float posY1, float posZ1, float posX2, float posY2, float posZ2,
	                             float radius, int red, int green, int blue, int alpha, int reserved)
	{
		return invoke<int>(0x0134F0835AB6BFCB, type, posX1, posY1, posZ1, posX2, posY2, posZ2, radius, red, green, blue,
		                   alpha, reserved);
	...
	static void REQUEST_STREAMED_TEXTURE_DICT(char* textureDict, BOOL p1)
	{
		invoke<Void>(0xDFA2EF8E04127DD5, textureDict, p1);
	} // 0xDFA2EF8E04127DD5 0x4C9B035F
	static BOOL HAS_STREAMED_TEXTURE_DICT_LOADED(char* textureDict)
	{
		return invoke<BOOL>(0x0145F696AAAAD2E4, textureDict);
	} // 0x0145F696AAAAD2E4 0x3F436EEF
	static void SET_STREAMED_TEXTURE_DICT_AS_NO_LONGER_NEEDED(char* textureDict)
	{
	...
	static void _0x6DD8F5AA635EB4B2(float p0, float p1, Any* p2, Any* p3)
	{
	...
	static void DRAW_SPRITE(char* textureDict, char* textureName, float screenX, float screenY, float width, float height,
	                        float heading, int red, int green, int blue, int alpha)
	{
		invoke<Void>(0xE7FFAE5EBF23D890, textureDict, textureName, screenX, screenY, width, height, heading, red, green, blue,
		             alpha);
	} // 0xE7FFAE5EBF23D890 0x1FEC16B0
	static Any ADD_ENTITY_ICON(Entity entity, char* icon) { return invoke<Any>(0x9CD43EEE12BF4DD0, entity, icon); }
	...
	static void SET_DRAW_ORIGIN(float x, float y, float z, Any p3) { invoke<Void>(0xAA0008F3BBB8F416, x, y, z, p3); }
	...
	static Vector3 GET_TEXTURE_RESOLUTION(char* textureDict, char* textureName)
	{
	...
	static void _0xB1BB03742917A5D6(int type, float xPos, float yPos, float zPos, float p4, int red, int green, int blue,
	                                int alpha)
	{
	...
	static BOOL _0x27FEB5254759CDE3(char* textureDict, BOOL p1)
	{
		return invoke<BOOL>(0x27FEB5254759CDE3, textureDict, p1);
	} // 0x27FEB5254759CDE3 0xD63FCB3E
	static int START_PARTICLE_FX_NON_LOOPED_AT_COORD(char* effectName, float xPos, float yPos, float zPos, float xRot,
	                                                 float yRot, float zRot, float scale, BOOL xAxis, BOOL yAxis,
	                                                 BOOL zAxis)
	{
		return invoke<int>(0x25129531F77B9ED3, effectName, xPos, yPos, zPos, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis);
	} // 0x25129531F77B9ED3 0xDD79D679
	static BOOL _START_PARTICLE_FX_NON_LOOPED_AT_COORD_2(char* effectName, float xPos, float yPos, float zPos, float xRot,
	                                                     float yRot, float zRot, float scale, BOOL xAxis, BOOL yAxis,
	                                                     BOOL zAxis)
	{
		return invoke<BOOL>(0xF56B8137DF10135D, effectName, xPos, yPos, zPos, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis);
	} // 0xF56B8137DF10135D 0x633F8C48
	static BOOL START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE(char* effectName, Ped ped, float offsetX, float offsetY,
	                                                     float offsetZ, float rotX, float rotY, float rotZ, int boneIndex,
	                                                     float scale, BOOL axisX, BOOL axisY, BOOL axisZ)
	{
		return invoke<BOOL>(0x0E7E72961BA18619, effectName, ped, offsetX, offsetY, offsetZ, rotX, rotY, rotZ, boneIndex,
		                    scale, axisX, axisY, axisZ);
	} // 0x0E7E72961BA18619 0x53DAEF4E
	static BOOL _START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2(char* effectName, Ped ped, float offsetX, float offsetY,
	                                                        float offsetZ, float rotX, float rotY, float rotZ,
	                                                        int boneIndex, float scale, BOOL axisX, BOOL axisY, BOOL axisZ)
	{
		return invoke<BOOL>(0xA41B6A43642AC2CF, effectName, ped, offsetX, offsetY, offsetZ, rotX, rotY, rotZ, boneIndex,
		                    scale, axisX, axisY, axisZ);
	} // 0xA41B6A43642AC2CF 0x161780C1
	static BOOL START_PARTICLE_FX_NON_LOOPED_ON_ENTITY(char* effectName, Entity entity, float offsetX, float offsetY,
	                                                   float offsetZ, float rotX, float rotY, float rotZ, float scale,
	                                                   BOOL axisX, BOOL axisY, BOOL axisZ)
	{
		return invoke<BOOL>(0x0D53A3B8DA0809D2, effectName, entity, offsetX, offsetY, offsetZ, rotX, rotY, rotZ, scale, axisX,
		                    axisY, axisZ);
	} // 0x0D53A3B8DA0809D2 0x9604DAD4
	static BOOL _START_PARTICLE_FX_NON_LOOPED_ON_ENTITY_2(char* effectName, Entity entity, float offsetX, float offsetY,
	                                                      float offsetZ, float rotX, float rotY, float rotZ, float scale,
	                                                      BOOL axisX, BOOL axisY, BOOL axisZ)
	{
		return invoke<BOOL>(0xC95EB1DB6E92113D, effectName, entity, offsetX, offsetY, offsetZ, rotX, rotY, rotZ, scale, axisX,
		                    axisY, axisZ);
	} // 0xC95EB1DB6E92113D
	...
	static int START_PARTICLE_FX_LOOPED_AT_COORD(char* effectName, float x, float y, float z, float xRot, float yRot,
	                                             float zRot, float scale, BOOL xAxis, BOOL yAxis, BOOL zAxis, BOOL p11)
	{
		return invoke<int>(0xE184F4F0DC5910E7, effectName, x, y, z, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis, p11);
	} // 0xE184F4F0DC5910E7 0xD348E3E6
	static int START_PARTICLE_FX_LOOPED_ON_PED_BONE(char* effectName, Ped ped, float xOffset, float yOffset, float zOffset,
	                                                float xRot, float yRot, float zRot, int boneIndex, float scale,
	                                                BOOL xAxis, BOOL yAxis, BOOL zAxis)
	{
		return invoke<int>(0xF28DA9F38CD1787C, effectName, ped, xOffset, yOffset, zOffset, xRot, yRot, zRot, boneIndex, scale,
		                   xAxis, yAxis, zAxis);
	} // 0xF28DA9F38CD1787C 0xF8FC196F
	static int START_PARTICLE_FX_LOOPED_ON_ENTITY(char* effectName, Entity entity, float xOffset, float yOffset,
	                                              float zOffset, float xRot, float yRot, float zRot, float scale,
	                                              BOOL xAxis, BOOL yAxis, BOOL zAxis)
	{
		return invoke<int>(0x1AE42C1660FD6517, effectName, entity, xOffset, yOffset, zOffset, xRot, yRot, zRot, scale, xAxis,
		                   yAxis, zAxis);
	} // 0x1AE42C1660FD6517 0x0D06FF62
	static int _START_PARTICLE_FX_LOOPED_ON_ENTITY_BONE(char* effectName, Entity entity, float xOffset, float yOffset,
	                                                    float zOffset, float xRot, float yRot, float zRot, int boneIndex,
	                                                    float scale, BOOL xAxis, BOOL yAxis, BOOL zAxis)
	{
		return invoke<int>(0xC6EB449E33977F0B, effectName, entity, xOffset, yOffset, zOffset, xRot, yRot, zRot, boneIndex,
		                   scale, xAxis, yAxis, zAxis);
	} // 0xC6EB449E33977F0B
	static int _START_PARTICLE_FX_LOOPED_ON_ENTITY_2(char* effectName, Entity entity, float xOffset, float yOffset,
	                                                 float zOffset, float xRot, float yRot, float zRot, float scale,
	                                                 BOOL xAxis, BOOL yAxis, BOOL zAxis)
	{
		return invoke<int>(0x6F60E89A7B64EE1D, effectName, entity, xOffset, yOffset, zOffset, xRot, yRot, zRot, scale, xAxis,
		                   yAxis, zAxis);
	} // 0x6F60E89A7B64EE1D 0x110752B2
	static int _START_PARTICLE_FX_LOOPED_ON_ENTITY_BONE_2(char* effectName, Entity entity, float xOffset, float yOffset,
	                                                      float zOffset, float xRot, float yRot, float zRot, int boneIndex,
	                                                      float scale, BOOL xAxis, BOOL yAxis, BOOL zAxis)
	{
		return invoke<int>(0xDDE23F30CC5A0F03, effectName, entity, xOffset, yOffset, zOffset, xRot, yRot, zRot, boneIndex,
		                   scale, xAxis, yAxis, zAxis);
	} // 0xDDE23F30CC5A0F03
	...
	static void SET_PARTICLE_FX_LOOPED_EVOLUTION(int ptfxHandle, char* propertyName, float amount, BOOL Id)
	{
	...
	static void SET_PARTICLE_FX_CAM_INSIDE_NONPLAYER_VEHICLE(Any p0, BOOL p1) { invoke<Void>(0xACEE6F360FC1F6B6, p0, p1); }
	...
	static void _SET_PARTICLE_FX_ASSET_OLD_TO_NEW(char* oldAsset, char* newAsset)
	{
		invoke<Void>(0xEA1E2D93F6F75ED9, oldAsset, newAsset);
	} // 0xEA1E2D93F6F75ED9
	static void _RESET_PARTICLE_FX_ASSET_OLD_TO_NEW(char* name) { invoke<Void>(0x89C8553DD3274AAE, name); }
	// 0x89C8553DD3274AAE
	...
	static Object ADD_DECAL(int decalType, float posX, float posY, float posZ, float p4, float p5, float p6, float p7,
	                        float p8, float p9, float width, float height, float rCoef, float gCoef, float bCoef,
	                        float opacity, float timeout, BOOL p17, BOOL p18, BOOL p19)
	{
		return invoke<Object>(0xB302244A1839BDAD, decalType, posX, posY, posZ, p4, p5, p6, p7, p8, p9, width, height, rCoef,
		                      gCoef, bCoef, opacity, timeout, p17, p18, p19);
	...
	static void _0x967278682CB6967A(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x967278682CB6967A, p0, p1, p2, p3); }
	...
	static void _ADD_DECAL_TO_MARKER(int decalType, char* textureDict, char* textureName)
	{
	...
	static BOOL _ADD_CLAN_DECAL_TO_VEHICLE(Vehicle vehicle, Ped ped, int boneIndex, float x1, float x2, float x3, float y1,
	                                       float y2, float y3, float z1, float z2, float z3, float scale, Any p13,
	                                       int alpha)
	{
		return invoke<BOOL>(0x428BDCB9DA58DA53, vehicle, ped, boneIndex, x1, x2, x3, y1, y2, y3, z1, z2, z3, scale, p13,
		                    alpha);
	...
	static BOOL _DOES_VEHICLE_HAVE_DECAL(Vehicle vehicle, Any p1) { return invoke<BOOL>(0x060D935D3981A275, vehicle, p1); }
	...
	static void SET_TRANSITION_TIMECYCLE_MODIFIER(char* modifierName, float transition)
	{
	...
	static int REQUEST_SCALEFORM_MOVIE_INSTANCE(char* scaleformName)
	{
		return invoke<int>(0xC514489CFB8AF806, scaleformName);
	} // 0xC514489CFB8AF806 0x7CC8057D
	static int _REQUEST_SCALEFORM_MOVIE_INTERACTIVE(char* scaleformName)
	{
	...
	static BOOL _HAS_NAMED_SCALEFORM_MOVIE_LOADED(char* scaleformName)
	{
	...
	static void DRAW_SCALEFORM_MOVIE(int scaleformHandle, float x, float y, float width, float height, int red, int green,
	                                 int blue, int alpha, int unk)
	{
	...
	{
		invoke<Void>(0x87D51D72255D4E78, scaleform, posX, posY, posZ, rotX, rotY, rotZ, p7, sharpness, p9, scaleX, scaleY,
		             scaleZ, p13);
	...
	static void _DRAW_SCALEFORM_MOVIE_3D_NON_ADDITIVE(int scaleform, float posX, float posY, float posZ, float rotX,
	                                                  float rotY, float rotZ, float p7, float p8, float p9, float scaleX,
	                                                  float scaleY, float scaleZ, Any p13)
	{
		invoke<Void>(0x1CE592FDC749D6F5, scaleform, posX, posY, posZ, rotX, rotY, rotZ, p7, p8, p9, scaleX, scaleY, scaleZ,
		             p13);
	} // 0x1CE592FDC749D6F5 0x899933C8
	static void CALL_SCALEFORM_MOVIE_METHOD(int scaleform, char* method)
	{
		invoke<Void>(0xFBD96D87AC96D533, scaleform, method);
	} // 0xFBD96D87AC96D533 0x7AB77B57
	static void _CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(int scaleform, char* functionName, float param1, float param2,
	...
	static void _CALL_SCALEFORM_MOVIE_FUNCTION_STRING_PARAMS(int scaleform, char* functionName, char* param1, char* param2,
	...
	static void _CALL_SCALEFORM_MOVIE_FUNCTION_MIXED_PARAMS(int scaleform, char* functionName, float floatParam1,
	                                                        float floatParam2, float floatParam3, float floatParam4,
	                                                        float floatParam5, char* stringParam1, char* stringParam2,
	                                                        char* stringParam3, char* stringParam4, char* stringParam5)
	{
		invoke<Void>(0xEF662D8D57E290B1, scaleform, functionName, floatParam1, floatParam2, floatParam3, floatParam4,
		             floatParam5, stringParam1, stringParam2, stringParam3, stringParam4, stringParam5);
	} // 0xEF662D8D57E290B1 0x6EAF56DE
	static BOOL _BEGIN_SCALEFORM_MOVIE_METHOD_HUD_COMPONENT(int hudComponent, char* functionName)
	{
		return invoke<BOOL>(0x98C494FD5BDFBFD5, hudComponent, functionName);
	} // 0x98C494FD5BDFBFD5 0x5D66CE1E
	static BOOL BEGIN_SCALEFORM_MOVIE_METHOD(int scaleform, char* functionName)
	{
		return invoke<BOOL>(0xF6E48914C7A8694E, scaleform, functionName);
	} // 0xF6E48914C7A8694E 0x215ABBE8
	static BOOL _BEGIN_SCALEFORM_MOVIE_METHOD_N(char* functionName)
	{
		return invoke<BOOL>(0xAB58C27C2E6123C6, functionName);
	} // 0xAB58C27C2E6123C6 0xF6015178
	static BOOL _BEGIN_SCALEFORM_MOVIE_METHOD_V(char* functionName)
	{
	...
	static char* SITTING_TV(int method_return) { return invoke<char*>(0xE1E258829A885245, method_return); }
	...
	static void _ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(float value) { invoke<Void>(0xD69736AAE04DB51A, value); }
	...
	static void BEGIN_TEXT_COMMAND_SCALEFORM_STRING(char* componentType)
	{
	...
	static void _ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING(char* value) { invoke<Void>(0xBA7148484BD90365, value); }
	// 0xBA7148484BD90365 0x4DAAD55B
	static void _ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BUTTON_NAME(char* button)
	{
	...
	static void DRAW_TV_CHANNEL(float xPos, float yPos, float xScale, float yScale, float rotation, int red, int green,
	                            int blue, int alpha)
	{
		invoke<Void>(0xFDDC2B4ED3C69DF0, xPos, yPos, xScale, yScale, rotation, red, green, blue, alpha);
	} // 0xFDDC2B4ED3C69DF0 0x8129EF89
	static void _LOAD_TV_CHANNEL_SEQUENCE(int TV_Channel, char* VideoSequence, BOOL Restart)
	{
		invoke<Void>(0xF7B38B8305F1FE8B, TV_Channel, VideoSequence, Restart);
	} // 0xF7B38B8305F1FE8B 0xB262DE67
	static void _0x2201C576FACAEBE8(Any p0, char* p1, Any p2) { invoke<Void>(0x2201C576FACAEBE8, p0, p1, p2); }
	...
	static BOOL _DRAW_SHOWROOM(char* p0, Ped ped, int p2, float posX, float posY, float posZ)
	{
	...
	static void _START_SCREEN_EFFECT(char* effectName, int duration, BOOL looped)
	{
	...
	static void _0xD2209BE128B5418C(char* graphicsName) { invoke<Void>(0xD2209BE128B5418C, graphicsName); }
	// 0xD2209BE128B5418C
}
...
namespace STATS
{
	...
	static BOOL STAT_SET_GXT_LABEL(Hash statName, char* value, BOOL save)
	{
	...
	static BOOL STAT_SET_STRING(Hash statName, char* value, BOOL save)
	{
	...
	static BOOL STAT_SET_USER_ID(Hash statName, char* value, BOOL save)
	{
	...
	static char* STAT_GET_STRING(Hash statHash, int p1) { return invoke<char*>(0xE50384ACC2C3DB74, statHash, p1); }
	...
	static char* STAT_GET_USER_ID(Any p0) { return invoke<char*>(0x2365C388E393BBE2, p0); }
	// 0x2365C388E393BBE2 0xE2E8B6BA
	static char* STAT_GET_LICENSE_PLATE(Hash statName) { return invoke<char*>(0x5473D4195058B2E4, statName); }
	// 0x5473D4195058B2E4 0x1544B29F
	static BOOL STAT_SET_LICENSE_PLATE(Hash statName, char* str)
	{
	...
	static Hash _GET_NGSTAT_BOOL_HASH(int index, BOOL spStat, BOOL charStat, int character, char* section)
	{
		return invoke<Hash>(0xBA52FF538ED2BC71, index, spStat, charStat, character, section);
	} // 0xBA52FF538ED2BC71
	static Hash _GET_NGSTAT_INT_HASH(int index, BOOL spStat, BOOL charStat, int character, char* section)
	{
	...
	static void _0x5009DFD741329729(char* p0, Any p1) { invoke<Void>(0x5009DFD741329729, p0, p1); }
	...
	static void _0x71862B1D855F32E1(Any* p0, Any p1, Any p2, Any p3) { invoke<Void>(0x71862B1D855F32E1, p0, p1, p2, p3); }
	// 0x71862B1D855F32E1 0xAC2C7C63
	static void _0x121FB4DDDC2D5291(Any p0, Any p1, Any p2, float p3) { invoke<Void>(0x121FB4DDDC2D5291, p0, p1, p2, p3); }
	...
	static void _0xCB00196B31C39EB1(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xCB00196B31C39EB1, p0, p1, p2, p3); }
	// 0xCB00196B31C39EB1 0x759E0EC9
	static void _0x2B69F5074C894811(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x2B69F5074C894811, p0, p1, p2, p3); }
	...
	static void PLAYSTATS_PROP_CHANGE(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xBA739D6D5A05D6E7, p0, p1, p2, p3); }
	...
	static Any LEADERBOARDS_GET_NUMBER_OF_COLUMNS(Any p0, Any p1) { return invoke<Any>(0x117B45156D7EFF2E, p0, p1); }
	// 0x117B45156D7EFF2E 0x0A56EE34
	static Any LEADERBOARDS_GET_COLUMN_ID(Any p0, Any p1, Any p2) { return invoke<Any>(0xC4B5467A1886EA7E, p0, p1, p2); }
	// 0xC4B5467A1886EA7E 0x3821A334
	static Any LEADERBOARDS_GET_COLUMN_TYPE(Any p0, Any p1, Any p2) { return invoke<Any>(0xBF4FEF46DB7894D3, p0, p1, p2); }
	...
	static Any LEADERBOARDS_READ_CLEAR(Any p0, Any p1, Any p2) { return invoke<Any>(0x7CCE5C737A665701, p0, p1, p2); }
	...
	static BOOL _0xC38DC1E90D22547C(Any* p0, Any* p1, Any* p2) { return invoke<BOOL>(0xC38DC1E90D22547C, p0, p1, p2); }
	// 0xC38DC1E90D22547C 0x9BEC3401
	static BOOL _0xF1AE5DCDBFCA2721(Any* p0, Any* p1, Any* p2) { return invoke<BOOL>(0xF1AE5DCDBFCA2721, p0, p1, p2); }
	// 0xF1AE5DCDBFCA2721
	...
	static void _0x11FF1C80276097ED(char* p0, Any p1, Any p2) { invoke<Void>(0x11FF1C80276097ED, p0, p1, p2); }
	...
	static void _0x6483C25849031C4F(Any p0, Any p1, Any p2, Any* p3) { invoke<Void>(0x6483C25849031C4F, p0, p1, p2, p3); }
	...
	static void _LEADERBOARDS_DEATHS(Hash statName, float value) { invoke<Void>(0x428EAF89E24F6C36, statName, value); }
	...
	static BOOL _0x3270F67EED31FBC1(Any p0, Any* p1, Any* p2) { return invoke<BOOL>(0x3270F67EED31FBC1, p0, p1, p2); }
	// 0x3270F67EED31FBC1
...
namespace BRAIN
{
	static void ADD_SCRIPT_TO_RANDOM_PED(char* name, Hash model, float p2, float p3)
	{
		invoke<Void>(0x4EE5367468A65CCC, name, model, p2, p3);
	} // 0x4EE5367468A65CCC 0xECC76C3D
	static void REGISTER_OBJECT_SCRIPT_BRAIN(char* scriptName, Hash objectName, int p2, float p3, int p4, int p5)
	{
...
namespace MOBILE
{
	static void CREATE_MOBILE_PHONE(Ped phoneType) { invoke<Void>(0xA4E8E696C532FBC7, phoneType); }
	...
	static BOOL _NETWORK_SHOP_DOES_ITEM_EXIST(char* name) { return invoke<BOOL>(0xBD4D7EAF8A30F637, name); }
	// 0xBD4D7EAF8A30F637
...
namespace PATHFIND
{
	...
	static BOOL GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(float x, float y, float z, Vector3* outPosition, float* outHeading,
	...
	static BOOL GET_NTH_CLOSEST_VEHICLE_NODE(float x, float y, float z, int nthClosest, Vector3* outPosition, Any unknown1,
	                                         Any unknown2, Any unknown3)
	{
	...
	static BOOL GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(float x, float y, float z, int nthClosest, Vector3* outPosition,
	                                                      float* heading, Any* unknown1, int unknown2, float unknown3,
	                                                      float unknown4)
	{
		return invoke<BOOL>(0x80CA6A8B6C094CC4, x, y, z, nthClosest, outPosition, heading, unknown1, unknown2, unknown3,
		                    unknown4);
	...
	static Any GET_NTH_CLOSEST_VEHICLE_NODE_ID_WITH_HEADING(float x, float y, float z, int nthClosest,
	                                                        Vector3* outPosition, float outHeading, Any p6, float p7,
	                                                        float p8)
	{
		return invoke<Any>(0x6448050E9C2A7207, x, y, z, nthClosest, outPosition, outHeading, p6, p7, p8);
	} // 0x6448050E9C2A7207 0xC1AEB88D
	static BOOL GET_NTH_CLOSEST_VEHICLE_NODE_FAVOUR_DIRECTION(float x, float y, float z, float desiredX, float desiredY,
	                                                          float desiredZ, int nthClosest, Vector3* outPosition,
	                                                          float* outHeading, int nodetype, Any p10, Any p11)
	{
		return invoke<BOOL>(0x45905BE8654AE067, x, y, z, desiredX, desiredY, desiredZ, nthClosest, outPosition, outHeading,
		                    nodetype, p10, p11);
	...
	static Any GET_CLOSEST_ROAD(float x, float y, float z, float p3, int p4, Vector3* p5, Vector3* p6, Any* p7, Any* p8,
	                            float* p9, BOOL p10)
	{
	...
	static void SET_ROADS_BACK_TO_ORIGINAL_IN_ANGLED_AREA(float x1, float y1, float z1, float x2, float y2, float z2,
	                                                      float p6)
	{
	...
	static int GENERATE_DIRECTIONS_TO_COORD(float x, float y, float z, BOOL p3, float* direction, float* p5,
	                                        float* distToNxJunction)
	{
		return invoke<int>(0xF90125F1F79ECDF8, x, y, z, p3, direction, p5, distToNxJunction);
	...
	static Any ADD_NAVMESH_BLOCKING_OBJECT(float p0, float p1, float p2, float p3, float p4, float p5, float p6, BOOL p7,
	                                       Any p8)
	{
...
namespace CONTROLS
{
	...
	// 0x6CD79468A1E595C6
	static char* GET_CONTROL_INSTRUCTIONAL_BUTTON(int inputGroup, int control, BOOL p2)
	{
		return invoke<char*>(0x0499D7B09FC9B407, inputGroup, control, p2);
	} // 0x0499D7B09FC9B407 0x3551727A
	static char* _0x80C2FD58D720C801(int inputGroup, int control, BOOL p2)
	{
		return invoke<char*>(0x80C2FD58D720C801, inputGroup, control, p2);
...
namespace DATAFILE
{
	...
	static BOOL _0xC84527E235FCA219(char* p0, BOOL p1, char* p2, Any* p3, Any* p4, char* type, BOOL p6)
	{
		return invoke<BOOL>(0xC84527E235FCA219, p0, p1, p2, p3, p4, type, p6);
	} // 0xC84527E235FCA219 0xF09157B0
	static BOOL _0xA5EFC3E847D60507(char* p0, char* p1, char* p2, char* p3, BOOL p4)
	{
		return invoke<BOOL>(0xA5EFC3E847D60507, p0, p1, p2, p3, p4);
	} // 0xA5EFC3E847D60507 0xD96860FC
	static BOOL _0x648E7A5434AF7969(char* p0, Any* p1, BOOL p2, Any* p3, Any* p4, Any* p5, char* type)
	{
		return invoke<BOOL>(0x648E7A5434AF7969, p0, p1, p2, p3, p4, p5, type);
	} // 0x648E7A5434AF7969 0x459F2683
	static BOOL _0x4645DE9980999E93(char* p0, char* p1, char* p2, char* p3, char* type)
	{
		return invoke<BOOL>(0x4645DE9980999E93, p0, p1, p2, p3, type);
	} // 0x4645DE9980999E93 0xDBB83E2B
	static BOOL _0x692D808C34A82143(char* p0, float p1, char* type)
	{
	...
	static void _ARRAY_VALUE_ADD_INTEGER(Any* arrayData, int value) { invoke<Void>(0xCABDB751D86FE93B, arrayData, value); }
	// 0xCABDB751D86FE93B 0xF29C0B36
	static void _ARRAY_VALUE_ADD_FLOAT(Any* arrayData, float value) { invoke<Void>(0x57A995FD75D37F56, arrayData, value); }
	// 0x57A995FD75D37F56 0xE4302123
	static void _ARRAY_VALUE_ADD_STRING(Any* arrayData, char* value)
	{
	...
	static char* _ARRAY_VALUE_GET_STRING(Any* arrayData, int arrayIndex)
	{
		return invoke<char*>(0xD3F2FFEB8D836F52, arrayData, arrayIndex);
...
namespace FIRE
{
	...
	static BOOL IS_EXPLOSION_IN_ANGLED_AREA(int explosionType, float x1, float y1, float z1, float x2, float y2, float z2,
	                                        float angle)
	{
		return invoke<BOOL>(0xA079A6C51525DC4B, explosionType, x1, y1, z1, x2, y2, z2, angle);
	} // 0xA079A6C51525DC4B 0x0128FED9
	static Entity _GET_PED_INSIDE_EXPLOSION_AREA(int explosionType, float x1, float y1, float z1, float x2, float y2,
...
namespace DECISIONEVENT
{
	...
	static void CLEAR_DECISION_MAKER_EVENT_RESPONSE(Hash name, int type) { invoke<Void>(0x4FC9381A7AEE8968, name, type); }
...
namespace ROPE
{
	static Object ADD_ROPE(float x, float y, float z, float rotX, float rotY, float rotZ, float length, int ropeType,
	                       float maxLength, float minLength, float p10, BOOL p11, BOOL p12, BOOL rigid, float p14,
	                       BOOL breakWhenShot, Any* unkPtr)
	{
		return invoke<Object>(0xE832D760399EB220, x, y, z, rotX, rotY, rotZ, length, ropeType, maxLength, minLength, p10, p11,
		                      p12, rigid, p14, breakWhenShot, unkPtr);
	...
	static void LOAD_ROPE_DATA(Object rope, char* rope_preset) { invoke<Void>(0xCBB203C04D1ABD27, rope, rope_preset); }
	...
	static void ATTACH_ENTITIES_TO_ROPE(Object rope, Entity ent1, Entity ent2, float ent1_x, float ent1_y, float ent1_z,
	                                    float ent2_x, float ent2_y, float ent2_z, float length, BOOL p10, BOOL p11,
	                                    char* boneName1, char* boneName2)
	{
		invoke<Void>(0x3D95EC8B6D940AC3, rope, ent1, ent2, ent1_x, ent1_y, ent1_z, ent2_x, ent2_y, ent2_z, length, p10, p11,
		             boneName1, boneName2);
	...
	static void SET_CGOFFSET(Object rope, float x, float y, float z) { invoke<Void>(0xD8FA3908D7B86904, rope, x, y, z); }
	...
	static void BREAK_ENTITY_GLASS(Any p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7, float p8,
	                               Any p9, BOOL p10)
	{
...
namespace WATER
{
	...
	static BOOL TEST_PROBE_AGAINST_WATER(float x1, float y1, float z1, float x2, float y2, float z2, Vector3* result)
	{
	...
	static void MODIFY_WATER(float x, float y, float z, float radius, float height)
	{
		invoke<Void>(0xC443FD757C3BA637, x, y, z, radius, height);
...
namespace WORLDPROBE
{
	...
	{
		return invoke<int>(0x7EE9F5D83DD4F90E, x1, y1, z1, x2, y2, z2, flags, entity, p8);
	} // 0x7EE9F5D83DD4F90E 0xEFAF4BA6
	static int _START_SHAPE_TEST_RAY(float x1, float y1, float z1, float x2, float y2, float z2, int flags, Entity entity,
	                                 int p8)
	{
	...
	static int _START_SHAPE_TEST_SURROUNDING_COORDS(Vector3* pVec1, Vector3* pVec2, int flag, Entity entity, int flag2)
	{
...
namespace NETWORK
{
	...
	// 0x78321BEA235FD8CD
	static BOOL _0x595F028698072DD9(Any p0, Any p1, BOOL p2) { return invoke<BOOL>(0x595F028698072DD9, p0, p1, p2); }
	// 0x595F028698072DD9 0xBB54AA3D
	static BOOL _0x83F28CE49FBBFFBA(Any p0, Any p1, BOOL p2) { return invoke<BOOL>(0x83F28CE49FBBFFBA, p0, p1, p2); }
	// 0x83F28CE49FBBFFBA
	...
	static void _NETWORK_SESSION_SET_MAX_PLAYERS(Any p0, Any p1) { invoke<Void>(0x8B6A4DD0AF9CE215, p0, p1); }
	...
	static void _0xABD5E88B8A2D3DB2(Any* globalPtr) { invoke<Void>(0xABD5E88B8A2D3DB2, globalPtr); }
	...
	static BOOL NETWORK_SEND_TEXT_MESSAGE(char* message, int* networkHandle)
	{
	...
	static void _0xEBEFC2E77084F599(Any p0, char* p1, BOOL p2) { invoke<Void>(0xEBEFC2E77084F599, p0, p1, p2); }
	// 0xEBEFC2E77084F599 0xE0C28DB5
	static BOOL NETWORK_SEND_TRANSITION_GAMER_INSTRUCTION(int* networkHandle, char* p1, int p2, int p3, BOOL p4)
	{
	...
	static void NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(int* vars, int numVars)
	{
		invoke<Void>(0x3E9B2F01C50DF595, vars, numVars);
	...
	static int NETWORK_GET_HOST_OF_SCRIPT(char* scriptName, int p1, int p2)
	{
	...
	static BOOL NETWORK_IS_SCRIPT_ACTIVE(char* scriptName, Player player, BOOL p2, Any p3)
	{
	...
	static void NETWORK_HANDLE_FROM_USER_ID(char* userId, int* networkHandle, int bufferSize)
	{
		invoke<Void>(0xDCD51DD8F87AEC5C, userId, networkHandle, bufferSize);
	} // 0xDCD51DD8F87AEC5C 0x74C2C1B7
	static void NETWORK_HANDLE_FROM_MEMBER_ID(char* memberId, int* networkHandle, int bufferSize)
	{
	...
	static char* NETWORK_GET_GAMERTAG_FROM_HANDLE(int* networkHandle)
	{
		return invoke<char*>(0x426141162EBE5CDB, networkHandle);
	...
	static char* NETWORK_MEMBER_ID_FROM_GAMER_HANDLE(int* networkHandle)
	{
		return invoke<char*>(0xC82630132081BB6F, networkHandle);
	...
	static char* NETWORK_PLAYER_GET_NAME(Player player) { return invoke<char*>(0x7718D2E2060837D2, player); }
	// 0x7718D2E2060837D2 0xCE48F260
	static char* NETWORK_PLAYER_GET_USERID(Player player, int* userID)
	{
		return invoke<char*>(0x4927FC39CD0869A0, player, userID);
	...
	static char* _NETWORK_GET_FRIEND_NAME_FROM_INDEX(int friendIndex)
	{
		return invoke<char*>(0x4164F227D052E293, friendIndex);
	} // 0x4164F227D052E293
	static BOOL NETWORK_IS_FRIEND_ONLINE(char* name) { return invoke<BOOL>(0x425A44533437B64D, name); }
	// 0x425A44533437B64D 0xE0A42430
	static BOOL _NETWORK_IS_FRIEND_ONLINE_2(int* networkHandle) { return invoke<BOOL>(0x87EB7A3FFCB314DB, networkHandle); }
	// 0x87EB7A3FFCB314DB
	...
	static Any NETWORK_IS_PENDING_FRIEND(Any p0) { return invoke<Any>(0x0BE73DA6984A6E33, p0); }
	...
	static BOOL NETWORK_ADD_FRIEND(int* networkHandle, char* message)
	{
	...
	static void _0xADB57E5B663CCA8B(Player p0, float* p1, float* p2) { invoke<Void>(0xADB57E5B663CCA8B, p0, p1, p2); }
	...
	static void _NETWORK_SET_RICH_PRESENCE_2(int p0, char* gxtLabel) { invoke<Void>(0x3E200C2BCF4164EB, p0, gxtLabel); }
	...
	static BOOL _NETWORK_CLAN_ANIMATION(char* animDict, char* animName)
	{
	...
	static void NETWORK_FADE_IN_ENTITY(Entity entity, BOOL state) { invoke<Void>(0x1F4ED342ACEFE62D, entity, state); }
	...
	static int NETWORK_CREATE_SYNCHRONISED_SCENE(float x, float y, float z, float xRot, float yRot, float zRot, int p6,
	                                             int p7, int p8, float p9, float p10, float p11)
	{
		return invoke<int>(0x7CD6BC4C2BBDD526, x, y, z, xRot, yRot, zRot, p6, p7, p8, p9, p10, p11);
	} // 0x7CD6BC4C2BBDD526 0xB06FE3FE
	static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(Ped ped, int netScene, char* animDict, char* animnName, float speed,
	                                                  float speedMultiplier, int duration, int flag, float playbackRate,
	                                                  Any p9)
	{
	...
	static void NETWORK_ADD_ENTITY_TO_SYNCHRONISED_SCENE(Entity entity, int netScene, char* animDict, char* animName,
	                                                     float speed, float speedMulitiplier, int flag)
	{
	...
	static void _NETWORK_FORCE_LOCAL_USE_OF_SYNCED_SCENE_CAMERA(int netScene, char* animDict, char* animName)
	{
	...
	static BOOL _0x5A6FFA2433E2F14C(Player player, float p1, float p2, float p3, float p4, float p5, float p6, float p7,
	                                int flags)
	{
		return invoke<BOOL>(0x5A6FFA2433E2F14C, player, p1, p2, p3, p4, p5, p6, p7, flags);
	} // 0x5A6FFA2433E2F14C 0xC62E77B3
	static BOOL _0x4BA92A18502BCA61(Player player, float p1, float p2, float p3, float p4, float p5, float p6, float p7,
	                                float p8, float p9, float p10, int flags)
	{
	...
	static BOOL NETWORK_DOES_TUNABLE_EXIST(char* tunableContext, char* tunableName)
	{
		return invoke<BOOL>(0x85E5F8B9B898B20A, tunableContext, tunableName);
	} // 0x85E5F8B9B898B20A 0x9FCE9C9A
	static BOOL NETWORK_ACCESS_TUNABLE_INT(char* tunableContext, char* tunableName, int* value)
	{
		return invoke<BOOL>(0x8BE1146DFD5D4468, tunableContext, tunableName, value);
	} // 0x8BE1146DFD5D4468 0xE4B3726A
	static BOOL NETWORK_ACCESS_TUNABLE_FLOAT(char* tunableContext, char* tunableName, float* value)
	{
		return invoke<BOOL>(0xE5608CA7BC163A5F, tunableContext, tunableName, value);
	} // 0xE5608CA7BC163A5F 0x41E8912A
	static BOOL NETWORK_ACCESS_TUNABLE_BOOL(char* tunableContext, char* tunableName)
	{
	...
	static int _GET_TUNABLES_CONTENT_MODIFIER_ID(Hash contentHash) { return invoke<int>(0x187382F8A3E0A6C3, contentHash); }
	...
	static BOOL _0x0EDE326D47CD0F3E(Ped ped, Player player) { return invoke<BOOL>(0x0EDE326D47CD0F3E, ped, player); }
	...
	static BOOL _0x158EC424F35EC469(char* p0, BOOL p1, char* contentType)
	{
	...
	static BOOL SET_BALANCE_ADD_MACHINES(Any* p0, Any p1, Any* p2) { return invoke<BOOL>(0xB8322EEB38BE7C26, p0, p1, p2); }
	...
	static char* _GET_ROOT_CONTENT_ID(Any p0) { return invoke<char*>(0xC0173D6BFF4E0348, p0); }
	...
	static BOOL _0x1DE0F5F50D723CAA(Any* p0, Any* p1, Any* p2) { return invoke<BOOL>(0x1DE0F5F50D723CAA, p0, p1, p2); }
	// 0x1DE0F5F50D723CAA 0xAD334B40
	static BOOL _0x274A1519DFC1094F(Any* p0, BOOL p1, Any* p2) { return invoke<BOOL>(0x274A1519DFC1094F, p0, p1, p2); }
	// 0x274A1519DFC1094F 0x980D45D7
	static BOOL _0xD05D1A6C74DA3498(Any* p0, BOOL p1, Any* p2) { return invoke<BOOL>(0xD05D1A6C74DA3498, p0, p1, p2); }
	...
	static BOOL _FACEBOOK_SET_HEIST_COMPLETE(char* heistName, int cashEarned, int xpEarned)
	{
	...
	static BOOL _FACEBOOK_SET_MILESTONE_COMPLETE(int milestoneId) { return invoke<BOOL>(0x0AE1F1653B554AB9, milestoneId); }
	...
	static int TEXTURE_DOWNLOAD_REQUEST(int* PlayerHandle, char* FilePath, char* Name, BOOL p3)
	{
		return invoke<int>(0x16160DA74A8E74A2, PlayerHandle, FilePath, Name, p3);
	} // 0x16160DA74A8E74A2 0xAD546CC3
	static Any _0x0B203B4AFDE53A4F(Any* p0, Any* p1, BOOL p2) { return invoke<Any>(0x0B203B4AFDE53A4F, p0, p1, p2); }
	...
	static BOOL _0xC22912B1D85F26B1(Any p0, Any* p1, Any* p2) { return invoke<BOOL>(0xC22912B1D85F26B1, p0, p1, p2); }
...
namespace NETWORKCASH
{
	...
	static void NETWORK_REFUND_CASH(int index, char* context, char* reason, BOOL unk)
	{
		invoke<Void>(0xF9C812CD7C46E817, index, context, reason, unk);
	} // 0xF9C812CD7C46E817 0x07C92F21
	static BOOL NETWORK_MONEY_CAN_BET(Any p0, BOOL p1, BOOL p2) { return invoke<BOOL>(0x81404F3DC124FE5B, p0, p1, p2); }
	...
	static void NETWORK_EARN_FROM_MISSION_H(int amount, char* heistHash)
	{
	...
	static void NETWORK_EARN_FROM_PERSONAL_VEHICLE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8)
	{
		invoke<Void>(0x3F4D00167E41E0AD, p0, p1, p2, p3, p4, p5, p6, p7, p8);
	} // 0x3F4D00167E41E0AD 0x96B8BEE8
	static void _NETWORK_EARN_FROM_DAILY_OBJECTIVE(int p0, char* p1, int p2)
	{
		invoke<Void>(0x6EA318C91C1A8786, p0, p1, p2);
	} // 0x6EA318C91C1A8786
	static void _NETWORK_EARN_FROM_AMBIENT_JOB(int p0, char* p1, Any* p2) { invoke<Void>(0xFB6DB092FBAE29E6, p0, p1, p2); }
	// 0xFB6DB092FBAE29E6
	static void _NETWORK_EARN_FROM_JOB_BONUS(Any p0, Any* p1, Any* p2) { invoke<Void>(0x6816FB4416760775, p0, p1, p2); }
	// 0x6816FB4416760775
	...
	static void NETWORK_BUY_ITEM(Ped player, Hash item, Any p2, Any p3, BOOL p4, char* item_name, Any p6, Any p7, Any p8,
	                             BOOL p9)
	{
	...
	static void NETWORK_SPENT_HELI_PICKUP(Any p0, BOOL p1, BOOL p2) { invoke<Void>(0x7BF1D73DB2ECA492, p0, p1, p2); }
	// 0x7BF1D73DB2ECA492 0x27EEBCAB
	static void NETWORK_SPENT_BOAT_PICKUP(Any p0, BOOL p1, BOOL p2) { invoke<Void>(0x524EE43A37232C00, p0, p1, p2); }
	...
	static void NETWORK_SPENT_HIRE_MUGGER(Any p0, BOOL p1, BOOL p2) { invoke<Void>(0xE404BFB981665BF0, p0, p1, p2); }
	...
	static void NETWORK_SPENT_HIRE_MERCENARY(Any p0, BOOL p1, BOOL p2) { invoke<Void>(0xE7B80E2BF9D80BD6, p0, p1, p2); }
	...
	static void NETWORK_SPENT_BUY_OFFTHERADAR(Any p0, BOOL p1, BOOL p2) { invoke<Void>(0xA628A745E2275C5D, p0, p1, p2); }
	...
	static void NETWORK_SPENT_BUY_PASSIVE_MODE(Any p0, BOOL p1, BOOL p2) { invoke<Void>(0x6D3A430D1A809179, p0, p1, p2); }
	...
	static void NETWORK_SPENT_REQUEST_JOB(Any p0, BOOL p1, BOOL p2) { invoke<Void>(0x8204DA7934DF3155, p0, p1, p2); }
	// 0x8204DA7934DF3155 0xD57A5125
	static void _NETWORK_SPENT_REQUEST_HEIST(Any p0, BOOL p1, BOOL p2) { invoke<Void>(0x9D26502BB97BFE62, p0, p1, p2); }
	// 0x9D26502BB97BFE62
...
namespace DLC1
{
	...
	static int _GET_NUM_FORCED_COMPONENTS(Hash componentHash) { return invoke<int>(0xC6B9DB42C04DD8C3, componentHash); }
	...
	static BOOL _0xA9F9C2E0FDE11CBB(Any p0, Any p1, Any* p2) { return invoke<BOOL>(0xA9F9C2E0FDE11CBB, p0, p1, p2); }
...
namespace SYSTEM
{
	...
	static int START_NEW_SCRIPT(char* scriptName, int stackSize)
	{
		return invoke<int>(0xE81651AD79516E48, scriptName, stackSize);
	} // 0xE81651AD79516E48 0x3F166D0E
	static int START_NEW_SCRIPT_WITH_ARGS(char* scriptName, Any* args, int argCount, int stackSize)
	{
...
namespace DECORATOR
{
	...
	static BOOL DECOR_IS_REGISTERED_AS_TYPE(char* propertyName, int type)
	{
...
namespace SOCIALCLUB
{
	...
	static BOOL SC_INBOX_MESSAGE_GET_DATA_INT(int p0, char* context, int* out)
	{
		return invoke<BOOL>(0xA00EFE4082C4056E, p0, context, out);
	} // 0xA00EFE4082C4056E 0x88068C7C
	static BOOL _SC_INBOX_MESSAGE_GET_DATA_BOOL(int p0, char* p1) { return invoke<BOOL>(0xFFE5C16F402D851D, p0, p1); }
	// 0xFFE5C16F402D851D
	static BOOL SC_INBOX_MESSAGE_GET_DATA_STRING(int p0, char* context, char* out)
	{
	...
	static BOOL _0x6AFD2CD753FEEF83(char* playerName) { return invoke<BOOL>(0x6AFD2CD753FEEF83, playerName); }
	...
	static void SC_EMAIL_MESSAGE_PUSH_GAMER_TO_RECIP_LIST(Player* player) { invoke<Void>(0x2330C12A7A605D16, player); }
	...
	static BOOL _SC_START_CHECK_STRING_TASK(char* string, int* taskHandle)
	{
	...
	// 0x2E89990DDFF670C3
	static BOOL _0xD0EE05FE193646EA(Any* p0, Any* p1, Any* p2) { return invoke<BOOL>(0xD0EE05FE193646EA, p0, p1, p2); }
	// 0xD0EE05FE193646EA
	static BOOL _0x1989C6E6F67E76A8(Any* p0, Any* p1, Any* p2) { return invoke<BOOL>(0x1989C6E6F67E76A8, p0, p1, p2); }
	// 0x1989C6E6F67E76A8
	...
	static BOOL _0x8CC469AB4D349B7C(int p0, char* p1, Any* p2) { return invoke<BOOL>(0x8CC469AB4D349B7C, p0, p1, p2); }
	// 0x8CC469AB4D349B7C 0xE778B2A7
	static BOOL _0x699E4A5C8C893A18(int p0, char* p1, Any* p2) { return invoke<BOOL>(0x699E4A5C8C893A18, p0, p1, p2); }
...
namespace UNK1
{
	...
	// 0x293220DA1B46CEBC
	static void _0x208784099002BC30(char* missionNameLabel, Any p1)
	{
...
namespace UNK3
{
	...
	static BOOL _0x51F1A8E48C3D2F6D(Any p0, BOOL p1, Any p2) { return invoke<BOOL>(0x51F1A8E48C3D2F6D, p0, p1, p2); }
	// 0x51F1A8E48C3D2F6D
...
static void _PED_DEATH_DROP(float x, float y, float z, int amount) { STREAMING::REQUEST_MODEL(-1666779307); invoke<Void>(14311548939713375618, x, y, z, amount, 1, -1666779307); }